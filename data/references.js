...
let references = [
  {
    title: "Product Design Director — 동일 조건으로 AI UI 비평 스킬 비교", category: "AI 디자인", date: "2026-09-07", url: "https://forum.figma.com/showcase-your-work-14/i-built-an-open-source-figma-custom-skill-for-hierarchy-states-responsive-ui-and-critique-57445",
    summary: "같은 1440×1024 지원 운영 화면과 프롬프트를 Figma agent에 적용해 스킬 유무에 따른 데스크톱·모바일 결과와 정보 보존 차이를 비교한 공개 사례.", note: "작업 맥락→위계→상태→반응형 우선순위→접근성→최종 비평을 고정하고 첫 결과를 그대로 비교해 AI 디자인 검수 절차와 한계를 함께 학습하기 좋음.", tags: ["#AI디자인", "#FigmaAgent", "#커스텀스킬", "#UI비평", "#반응형", "#테크IT"], thumbnail: "https://raw.githubusercontent.com/Tmmy-inter/figma-product-design-director/main/evidence/r2/comparison/skill-desktop.png", visual: { background: "#f4f5f7", accent: "#6750a4", ink: "#1f2430", radiusOne: "16px", radiusTwo: "8px", rotate: "-1deg", label: "CONTEXT / CRITIQUE / RECHECK" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "공개 저장소가 동일 시작 프레임·브리프·출력 크기에서 스킬 유무만 바꾼 첫 실행 PNG, 프롬프트, 해시와 평가를 제공해 AI UI 비평 흐름을 반복 검토할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "접근성", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://raw.githubusercontent.com/Tmmy-inter/figma-product-design-director/main/evidence/r2/comparison/skill-desktop.png", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "제품 맥락→과업 중심 위계→컴포넌트 상태→반응형 우선순위→접근성 검토→관찰 조건·영향·최소 수정·전체 흐름 재검사", "controls": "동일 1440×1024 seed·동일 brief·desktop 1440×1024/mobile 390×844·첫 완료 결과·작업자 재시도 0회" } }, "출처": { "소스": "https://github.com/Tmmy-inter/figma-product-design-director/blob/main/examples/case-study-01-support-operations-workspace.md", "수집일": "2026-09-07", "수집사유": "2026-09-03 공개 Figma 포럼 글과 저장소에서 실제 데스크톱·모바일 결과, 통제 조건과 재현 절차 확인" } }
  },
  {
    title: "Carbon Progress Bar — 상태·정렬·크기를 토큰 계약으로", category: "웹 스타일가이드", date: "2026-09-07", url: "https://carbondesignsystem.com/components/progress-bar/style/",
    summary: "진행·완료·오류·비활성 상태와 기본·인라인·들여쓰기 정렬, 4px·8px 높이, 라벨·도움말 간격을 실제 화면과 수치로 정리한 공식 사양.", note: "진행률 색만 정하는 데서 그치지 않고 상태 아이콘, 텍스트 정렬, 최소 폭과 간격 토큰까지 묶어 업로드·처리 UI의 구현 편차를 줄이기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#프로그레스바", "#상태", "#디자인토큰", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/5affeac033a67a8463cecbb6330dc7ff/3cbba/progress-bar-style-1.png", visual: { background: "#f4f4f4", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "STATUS / ALIGN / SIZE" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 진행률 상태·텍스트 정렬·최소 폭·4/8px 높이·간격 토큰을 실제 PNG와 연결해 구현 가능한 컴포넌트 계약을 제공한다.", "metadata": { "정보렌즈": ["정보구조", "브랜드일관성", "접근성", "인터랙션"], "시각렌즈": ["미니멀", "모노톤", "그리드", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/5affeac033a67a8463cecbb6330dc7ff/3cbba/progress-bar-style-1.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "component": "progress bar", "states": "active·finished·error·inactive", "tokens": "spacing-03·spacing-05·helper-text-01", "dimensions": "minimum width 48px·big 8px·small 4px" } }, "출처": { "소스": "https://carbondesignsystem.com/components/progress-bar/style/", "수집일": "2026-09-07", "수집사유": "2026-08-27 갱신 공식 디자인 시스템에서 상태별 실제 컴포넌트와 구조·크기 사양 확인" } }
  },
  {
    title: "Carbon Sentence Case — 제품 UI 전체의 대소문자 규칙", category: "콘텐츠 디자인 가이드", date: "2026-09-07", url: "https://carbondesignsystem.com/guidelines/content/writing-style/",
    summary: "페이지 제목·탭·모듈 제목·링크·버튼·표 머리글과 본문을 하나의 실제 제품 화면에서 sentence case로 통일하고 예외를 명시한 공식 가이드.", note: "추상적인 문체 원칙이 아니라 동일 화면의 여러 UI 요소를 한 번에 대조할 수 있어 제품 전반의 대소문자 감사와 카피 QA 체크리스트로 바로 전환하기 좋음.", tags: ["#콘텐츠디자인", "#Carbon", "#SentenceCase", "#UI카피", "#타이포그래피", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/1e28d1f3169d3f3b2a0e83a6d6553ca3/3cbba/sentence_case_786.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "TITLE / LABEL / TABLE" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 가이드가 제목·탭·버튼·링크·표 카피가 sentence case로 적용된 1152×720 실제 화면과 제품명·약어 예외를 제공해 UI 카피 감사에 즉시 적용할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성", "접근성", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://carbondesignsystem.com/static/1e28d1f3169d3f3b2a0e83a6d6553ca3/3cbba/sentence_case_786.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "UI 문자열 목록화→첫 단어와 고유명사만 대문자→title case·all caps 제거→제품명·약어 예외 대조→화면 단위 재검사", "visible_examples": "페이지 제목·탭·모듈 제목·링크·버튼·표 머리글·표 본문" } }, "출처": { "소스": "https://carbondesignsystem.com/guidelines/content/writing-style/", "수집일": "2026-09-07", "수집사유": "최근 갱신 공식 콘텐츠 가이드에서 규칙이 적용된 실제 제품 화면과 잘못된 예시 확인" } }
  },
  {
    title: "Web Behavior Preview — Figma 프로토타입을 실제 스크롤 웹으로", category: "Figma 플러그인", date: "2026-09-07", url: "https://www.figma.com/community/plugin/1676379978276045790/web-behavior-preview",
    summary: "스티키 헤더·사이드바·하단 바·클릭·호버·오버레이가 포함된 Figma 페이지를 실제 브라우저 동작으로 열고 단일 HTML로 내보내는 플러그인.", note: "정적인 화면 설명 대신 긴 페이지의 스크롤·고정·오버레이 행동을 클라이언트가 직접 체험하게 해 프로토타입 전달과 인터랙션 검수 시간을 줄이기 좋음.", tags: ["#Figma플러그인", "#프로토타입", "#스크롤", "#Sticky", "#HTML내보내기", "#테크IT"], thumbnail: "https://www.figma.com/community/thumbnail?resource_id=1676379978276045790&resource_type=plugin", visual: { background: "#eef2ff", accent: "#5b5bd6", ink: "#202038", radiusOne: "16px", radiusTwo: "8px", rotate: "1deg", label: "STICKY / SCROLL / EXPORT" },
    review: { "유형": "Figma 플러그인", "가치축_이름": "유용성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Figma Community 공식 커버와 공개 플레이그라운드가 스티키·호버·클릭·오버레이를 브라우저에서 재생하고 한 파일로 내보내는 반복 전달 흐름을 보여줘 실무 검수 시간을 줄일 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "인터랙션", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://www.figma.com/community/thumbnail?resource_id=1676379978276045790&resource_type=plugin", "커버리지_카테고리": "Figma 플러그인", "보안_등급": "raw_ok", "type_block": { "inputs": "Figma page와 Prototype 탭의 click·hover·overlay 연결", "outputs": "실제 스크롤 웹 미리보기·단일 self-contained HTML", "workflow": "페이지 선택→동작 추론→브라우저 미리보기→HTML export" } }, "출처": { "소스": "https://forum.figma.com/showcase-your-work-14/web-behavior-preview-open-your-figma-page-as-a-real-scrolling-webpage-57408", "수집일": "2026-09-07", "수집사유": "2026-09-01 공개 공식 Figma 포럼 글과 Community 커버에서 실행 범위·플레이그라운드·출력 방식 확인" } }
  },
  {
    title: "Mosaic Mural Mockup — 평면 그래픽을 타일 벽면으로", category: "AI 이미지 프롬프트", date: "2026-09-07", url: "https://help.runwayml.com/hc/en-us/articles/50984956601107-Mockup#mosaic-mural",
    summary: "입력 그래픽을 Mosaic Mural 프리셋으로 실제 타일 벽면에 배치해 반복 조각과 환경 원근이 살아 있는 공개 Mockup 결과.", note: "디자인 자체는 입력으로 고정하고 표면·스케일·현장 맥락만 프리셋으로 분리해 공공 설치물과 브랜드 공간 시안을 빠르게 비교하기 좋음.", prompt: "Preset: Mosaic Mural", tags: ["#AI이미지프롬프트", "#Mockup", "#모자이크", "#벽화", "#공간브랜딩", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/50993959943955", visual: { background: "#e9e2d6", accent: "#3f6f79", ink: "#20272a", radiusOne: "8px", radiusTwo: "24px", rotate: "-1deg", label: "ART / TILE / WALL" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Mockup 문서가 입력 그래픽, Mosaic Mural 프리셋, Nano Banana 계열 모델·출력 수 설정과 결과 PNG를 함께 제공해 공간 배치 시안으로 재현할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "AI활용"], "시각렌즈": ["일러스트", "그리드", "매트", "유희적"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/50993959943955", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Preset: Mosaic Mural", "tool_model": "Runway Mockup / Nano Banana Pro or Nano Banana", "params": "design image https://help.runwayml.com/hc/article_attachments/50993997366931·Mosaic Mural preset·output 1 or 4·aspect ratio/seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/50993959943955", "fragment_map": [{ "조각": "design image input", "효과": "평면 그래픽의 색·형태·구성 유지" }, { "조각": "Mosaic", "효과": "이미지를 작은 타일 조각의 반복 표면으로 변환" }, { "조각": "Mural", "효과": "그래픽을 건축 벽면 규모와 원근에 맞춰 배치" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/50984956601107-Mockup", "수집일": "2026-09-07", "수집사유": "최근 30일 공개 공식 앱 문서에서 입력·프리셋·모델·설정·결과 PNG 확인" } }
  },
  {
    title: "Night Corner Story Panels — 군중 속 소실로 장면 확장", category: "AI 이미지 프롬프트", date: "2026-09-07", url: "https://help.runwayml.com/hc/en-us/articles/50985233945747-Story-Panels#night-crowd",
    summary: "어두운 거리 모퉁이 한 장에서 인물이 코너를 돌아 군중 속으로 사라지는 다음 장면을 두 개의 패널 시퀀스로 확장한 공식 결과.", note: "입력 장면의 야간 블루톤과 공간 연속성은 유지하면서 회전·소실·군중이라는 행동만 짧게 지정해 스릴러 콘티의 다음 비트를 빠르게 탐색하기 좋음.", prompt: "The figure turns the corner and disappears into the crowd", tags: ["#AI이미지프롬프트", "#StoryPanels", "#블루톤", "#야간", "#스토리보드", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51009689353363", visual: { background: "#152433", accent: "#3d83a8", ink: "#edf5f8", radiusOne: "8px", radiusTwo: "24px", rotate: "1deg", label: "TURN / CROWD / VANISH" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Runway 공식 Story Panels 문서가 야간 거리 입력, 전체 장면 지시, 2패널·최대 48크레딧 설정과 결과 PNG를 제공해 블루톤 장면의 연속 서사를 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "모노톤", "비대칭", "하드라이트", "차가움"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51009689353363", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "The figure turns the corner and disappears into the crowd", "tool_model": "Runway Story Panels", "params": "input image https://help.runwayml.com/hc/article_attachments/51009744760979·2 panels·up to 48 credits·aspect ratio/seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51009689353363", "fragment_map": [{ "조각": "turns the corner", "효과": "입력 모퉁이를 다음 행동의 전환점으로 사용" }, { "조각": "disappears", "효과": "인물 가시성을 단계적으로 낮춰 소실 비트 생성" }, { "조각": "into the crowd", "효과": "배경 군집을 은폐 장치이자 깊이 레이어로 확장" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/50985233945747-Story-Panels", "수집일": "2026-09-07", "수집사유": "최근 30일 공식 앱 문서에서 입력 이미지·전체 프롬프트·생성 설정·블루톤 결과 PNG 확인" } }
  },
  {
    title: "Victorian Hedge Maze — 전신 구도 안에서 여우만 접근", category: "AI 영상 프롬프트", date: "2026-09-07", url: "https://help.runwayml.com/hc/en-us/articles/46749315925395-Camera-Terms-Prompts-Examples#full-victorian-maze",
    summary: "빅토리아풍 인물이 미로를 천천히 걷는 전신 구도는 유지하고 작은 여우만 카메라 쪽으로 접근하게 한 Gen-4.5 공식 결과.", note: "사람의 진행 방향과 동물의 렌즈 접근을 분리해 한 숏 안에서 두 피사체의 속도·거리·주목도 변화를 설계하는 기준 샘플로 쓰기 좋음.", prompt: "A full shot observes a Victorian woman as she slowly navigates the hedgemaze, beside a small, curious fox. The fox approaches the camera.", tags: ["#AI영상프롬프트", "#Gen45", "#전신샷", "#헤지메이즈", "#피사체동선", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/46973623633427", visual: { background: "#29372c", accent: "#bd7b48", ink: "#f3efe8", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "FULL / WALK / APPROACH" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 카메라 라이브러리가 전체 프롬프트·Gen-4.5 모델·결과 GIF를 제공해 전신 구도에서 사람 이동과 여우의 렌즈 접근을 분리 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "AI활용"], "시각렌즈": ["에디토리얼", "어스톤", "중앙집중", "소프트확산광", "몽환", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/46973623633427", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "A full shot observes a Victorian woman as she slowly navigates the hedgemaze, beside a small, curious fox. The fox approaches the camera.", "tool_model": "Runway Gen-4.5 Text to Video", "params": "2–10초·16:9/9:16/1:1/4:3/3:4/21:9·720p·24/25fps·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/46973623633427", "fragment_map": [{ "조각": "A full shot observes", "효과": "인물의 전신과 주변 미로를 함께 유지" }, { "조각": "slowly navigates the hedgemaze", "효과": "사람에게 느린 횡적 이동과 탐색 동작 부여" }, { "조각": "The fox approaches the camera", "효과": "동물만 렌즈 방향으로 가까워지며 깊이 변화 생성" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/46749315925395-Camera-Terms-Prompts-Examples", "수집일": "2026-09-07", "수집사유": "최근 갱신 공식 카메라 예시에서 전체 프롬프트·모델·설정 범위·결과 GIF 확인" } }
  },
  {
    title: "Elastic Apartment Lockoff — 건물만 유기적으로 변형", category: "AI 영상 프롬프트", date: "2026-09-07", url: "https://help.runwayml.com/hc/en-us/articles/46749315925395-Camera-Terms-Prompts-Examples#static-elastic-building",
    summary: "카메라는 완전히 고정한 채 아파트 건물이 늘어나 원형과 유기적 추상 형태로 휘어지는 변형만 프레임 안에 남긴 Gen-4.5 결과.", note: "정적 카메라 지시를 반복하고 운동 주체를 건물 하나로 한정해 건축·제품 변형 숏에서 카메라 드리프트와 피사체 모션을 분리 검수하기 좋음.", prompt: "Static, completely still establishing shot remains motionless, focused on a single apartment building. The apartment building begins to stretch and curve with an elastic-like quality, bending into circular shapes and impossibly stretching and bending into an organic abstract shape. The camera is entirely motionless for the duration of the scene, with movement only occurring from the building moving within the locked perspective.", tags: ["#AI영상프롬프트", "#Gen45", "#고정카메라", "#건축", "#형태변형", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/46994018122515", visual: { background: "#d8d4cd", accent: "#7d5d4b", ink: "#231f1c", radiusOne: "8px", radiusTwo: "24px", rotate: "1deg", label: "LOCK / STRETCH / BEND" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Runway 공식 카메라 라이브러리가 정적 구도를 반복 강화한 전체 프롬프트·Gen-4.5 모델·결과 GIF를 제공해 카메라를 잠그고 건물 변형만 재현할 수 있다.", "metadata": { "정보렌즈": ["AI활용", "콘텐츠명료성"], "시각렌즈": ["3D", "모노톤", "중앙집중", "매트", "몽환", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/46994018122515", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Static, completely still establishing shot remains motionless, focused on a single apartment building. The apartment building begins to stretch and curve with an elastic-like quality, bending into circular shapes and impossibly stretching and bending into an organic abstract shape. The camera is entirely motionless for the duration of the scene, with movement only occurring from the building moving within the locked perspective.", "tool_model": "Runway Gen-4.5 Text to Video", "params": "2–10초·16:9/9:16/1:1/4:3/3:4/21:9·720p·24/25fps·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/46994018122515", "fragment_map": [{ "조각": "Static, completely still establishing shot", "효과": "장면 시작부터 카메라 위치를 고정" }, { "조각": "stretch and curve with an elastic-like quality", "효과": "건물 표면과 골격에 탄성 변형 부여" }, { "조각": "bending into circular shapes", "효과": "직선 건축을 원형 윤곽으로 단계 전환" }, { "조각": "movement only occurring from the building", "효과": "운동 범위를 건물 하나로 한정" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/46749315925395-Camera-Terms-Prompts-Examples", "수집일": "2026-09-07", "수집사유": "최근 갱신 공식 카메라 예시에서 전체 프롬프트·모델·설정 범위·결과 GIF 확인" } }
  },
  {
    title: "Orilla — 안전한 파일 전달을 상태 중심 UI로", category: "웹·앱 UI", date: "2026-09-07", url: "https://www.behance.net/gallery/255169811/Brand-identity-UXUI-Design-Art-Direction",
    summary: "프리랜서와 클라이언트가 프로젝트·합의·보호된 파일·전달 상태를 각 역할에 맞게 확인하고 최종 공개까지 관리하는 실제 플랫폼 화면.", note: "결제 기능을 억지로 포함하지 않고 파일 보호와 전달 상태라는 핵심 불안을 정보 구조·색 상태·역할별 화면으로 좁혀 B2B 협업 서비스 설계에 전이하기 좋음.", tags: ["#웹앱UI", "#파일전달", "#프리랜서", "#대시보드", "#상태설계", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/7ad6c1255169811.6a9871ee7ebe1.jpg", visual: { background: "#f4f8f7", accent: "#29a985", ink: "#173b35", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "PROJECT / PROTECT / RELEASE" },
    review: { "유형": "웹·앱 UI", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-09-02 공개 프로젝트가 역할별 프로젝트·합의·전달·파일 보호·상태 화면과 실제 서비스 링크를 제공해 창작물 전달 흐름으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "브랜드일관성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "파스텔", "그리드", "여백중심", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/7ad6c1255169811.6a9871ee7ebe1.jpg", "커버리지_카테고리": "웹·앱 UI", "보안_등급": "raw_ok", "type_block": { "roles": "creator/freelancer·client", "screens": "프로젝트·클라이언트·합의·보호 파일·전달 상태·지표", "flow": "프로젝트 생성→합의 확인→파일 보호 전달→상태 검토→최종 공개" } }, "출처": { "소스": "https://www.behance.net/gallery/255169811/Brand-identity-UXUI-Design-Art-Direction", "수집일": "2026-09-07", "수집사유": "2026-09-02 공개 Behance 프로젝트에서 정보 구조·와이어프레임·역할별 실제 UI와 서비스 맥락 확인" } }
  },
  {
    title: "Creative Graphic Showcase — 매체를 가로지르는 고대비 포스터 문법", category: "비주얼 그래픽", date: "2026-09-07", url: "https://www.behance.net/gallery/255092437/Creative-Graphic-Design-Showcase",
    summary: "강한 타이포 위계·고대비 색면·대각선 구도와 반복 그래픽을 소셜 캐러셀·포스터·인쇄물·머천다이즈에 확장한 그래픽 모음.", note: "매체가 바뀌어도 큰 제목, 제한 팔레트, 시선 축과 반복 모듈을 유지하는 방식이 캠페인용 그래픽 템플릿을 설계할 때 재사용하기 좋음.", tags: ["#비주얼그래픽", "#포스터", "#타이포그래피", "#고채도", "#소셜그래픽"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/4aa8e2255092437.6a96ab1e41e2d.png", visual: { background: "#161616", accent: "#ff5a36", ink: "#f7f2e8", radiusOne: "0", radiusTwo: "24px", rotate: "-2deg", label: "TYPE / CONTRAST / REPEAT" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 3, "근거성": 5, "가치축": 5 }, "total": 18, "verdict": "accept", "근거": "2026-09-01 공개 프로젝트가 큰 타이포·고대비 색면·대각선 축·반복 모듈을 소셜·인쇄·포스터·패키지 결과에 일관되게 적용해 캠페인 그래픽 규칙으로 추출할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성"], "시각렌즈": ["에디토리얼", "하이채도", "비대칭", "고밀도", "매트", "유희적"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/4aa8e2255092437.6a96ab1e41e2d.png", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "elements": "대형 제목·제한 고채도 팔레트·대각선 시선 축·반복 모듈", "applications": "소셜 캐러셀·포스터·인쇄물·패키지·머천다이즈" } }, "출처": { "소스": "https://www.behance.net/gallery/255092437/Creative-Graphic-Design-Showcase", "수집일": "2026-09-07", "수집사유": "2026-09-01 공개 Behance 프로젝트에서 다매체 실제 결과 이미지와 반복 시각 규칙 확인" } }
  },
  {
    title: "STRYDE — 움직임을 고정한 레드·블랙 스포츠 아이덴티티", category: "브랜드", date: "2026-09-07", url: "https://www.behance.net/gallery/255317641/STRYDE-Sports-Brand-Identity-Campaign-Design",
    summary: "레드·블랙·화이트 팔레트, 압축된 굵은 타이포, 고대비 운동 사진과 사선 구조를 이벤트·옥외·디지털 캠페인에 확장한 스포츠 브랜드 시스템.", note: "속도감을 효과에 의존하지 않고 타이포 폭, 사선, 사진 크롭과 색 역할로 반복해 대형 현장물과 작은 디지털 자산 사이의 일관성을 유지한 점이 강함.", tags: ["#브랜드", "#스포츠", "#레드블랙", "#캠페인", "#옥외광고", "#타이포그래피"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/857333255317641.6a9d1df109fc4.png", visual: { background: "#111111", accent: "#e52329", ink: "#ffffff", radiusOne: "0", radiusTwo: "8px", rotate: "1deg", label: "TYPE / MOTION / IMPACT" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-09-06 공개 프로젝트가 레드·블랙·화이트, 굵은 타이포·사선·고대비 사진을 포스터·스탠디·옥외·디지털 결과에 반복해 스포츠 캠페인 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["스위스", "하이채도", "비대칭", "하드라이트", "매트"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/857333255317641.6a9d1df109fc4.png", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "system": "레드·블랙·화이트 역할 팔레트·압축 굵은 타이포·사선 레이아웃·고대비 운동 사진", "applications": "이벤트 포스터·스탠디·옥외 활성화·디지털 캠페인" } }, "출처": { "소스": "https://www.behance.net/gallery/255317641/STRYDE-Sports-Brand-Identity-Campaign-Design", "수집일": "2026-09-07", "수집사유": "2026-09-06 공개 Behance 프로젝트에서 브랜드 규칙과 이벤트·옥외·디지털 실제 적용 이미지 확인" } }
  },
  {
    title: "Linear Priority Inbox — 분류 결과와 규칙을 한 화면에서", category: "웹·앱 UI", date: "2026-09-06", url: "https://linear.app/changelog/2026-09-03-priority-inbox",
    summary: "알림을 Priority와 Other로 나누고 기본 분류 위에 소스·필터 규칙을 더해 중요한 업데이트만 집중하게 하는 Linear의 실제 인박스 화면.", note: "자동 분류 결과를 숨기지 않고 탭과 사용자 규칙으로 드러내 AI 보조 기능의 통제권과 스캔 효율을 함께 설계한 점이 협업 제품에 유용함.", tags: ["#웹앱UI", "#Linear", "#인박스", "#우선순위", "#AI분류", "#테크IT"], thumbnail: "https://webassets.linear.app/images/ornj730p/production/8005be22da38ee19e6ac56569976958564d9bbb1-3600x2080.png?auto=format&dpr=2&q=95", visual: { background: "#17181b", accent: "#7c5cff", ink: "#f5f5f7", radiusOne: "16px", radiusTwo: "8px", rotate: "-1deg", label: "PRIORITY / OTHER / RULES" },
    review: { "유형": "웹·앱 UI", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Linear 공식 변경 로그가 Priority·Other 탭, 자동 분류와 사용자 정의 소스·필터가 적용된 실제 제품 화면을 공개해 알림 우선순위 흐름으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "인터랙션", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://webassets.linear.app/images/ornj730p/production/8005be22da38ee19e6ac56569976958564d9bbb1-3600x2080.png?auto=format&dpr=2&q=95", "커버리지_카테고리": "웹·앱 UI", "보안_등급": "raw_ok", "type_block": { "screens": "Priority·Other 탭과 알림 리스트, 사용자 정의 우선순위 규칙 화면", "flow": "알림 수신→기본 우선순위 분류→소스·필터 규칙 적용→Priority 탭 집중 처리" } }, "출처": { "소스": "https://linear.app/changelog/2026-09-03-priority-inbox", "수집일": "2026-09-06", "수집사유": "2026-09-03 공개 공식 변경 로그에서 실제 제품 화면과 분류·규칙 동작 확인" } }
  },
  {
    title: "Linear Agent Project Draft — 맥락에서 실행 계획까지", category: "AI 디자인", date: "2026-09-06", url: "https://linear.app/changelog/2026-09-03-priority-inbox#draft-projects-with-linear-agent",
    summary: "프로젝트 작성기에서 워크스페이스와 연결 도구의 맥락을 불러와 브리프를 다듬고 계획을 구성한 뒤 자동 저장하는 Linear Agent 흐름.", note: "빈 프롬프트에서 결과를 생성하는 대신 기존 업무 맥락, 브리프 보정, 단계형 계획, 초안 저장을 한 흐름으로 묶어 AI 기획 기능의 신뢰도를 높임.", tags: ["#AI디자인", "#LinearAgent", "#프로젝트기획", "#워크플로", "#생성형AI", "#테크IT"], thumbnail: "https://webassets.linear.app/images/ornj730p/production/0e436be9125079b223439fcb01d4db5feae680a8-3600x2368.png?auto=format&dpr=2&q=95", visual: { background: "#15161a", accent: "#8b6dff", ink: "#f4f4f6", radiusOne: "16px", radiusTwo: "8px", rotate: "1deg", label: "CONTEXT / BRIEF / PLAN" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 4 }, "total": 19, "verdict": "accept", "근거": "Linear 공식 변경 로그가 워크스페이스 맥락 수집, 브리프 개선, 계획 생성과 자동 저장이 이어지는 실제 작성기 화면을 공개해 AI 프로젝트 초안 흐름으로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "인터랙션", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://webassets.linear.app/images/ornj730p/production/0e436be9125079b223439fcb01d4db5feae680a8-3600x2368.png?auto=format&dpr=2&q=95", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "워크스페이스·연결 도구 맥락 수집→브리프 보정→프로젝트 계획 생성→초안 자동 저장", "ai_role": "기존 업무 맥락을 프로젝트 브리프와 실행 단계로 구조화" } }, "출처": { "소스": "https://linear.app/changelog/2026-09-03-priority-inbox", "수집일": "2026-09-06", "수집사유": "2026-09-03 공개 공식 변경 로그에서 Linear Agent 작성기와 생성 단계 확인" } }
  },
  {
    title: "Carbon Text Input AI Presence — 생성 상태와 사용자 수정을 구분", category: "웹 스타일가이드", date: "2026-09-06", url: "https://carbondesignsystem.com/components/text-input/usage/#ai-presence",
    summary: "텍스트 입력의 AI 생성 상태를 라벨·설명 트리거로 표시하고 사용자가 값을 수정하면 일반 상태로, 되돌리면 AI 상태로 복원하는 공식 패턴.", note: "AI가 만든 값과 사람이 확정한 값을 색만으로 표시하지 않고 설명 가능성·상태 전환까지 컴포넌트 계약에 넣어 감사 가능한 폼 설계에 적용하기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#텍스트입력", "#AI상태", "#설명가능성", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/d1665edaa143cbede74495086df633ca/3cbba/text-input-text-area-ai-presence-default.png", visual: { background: "#f4f4f4", accent: "#8a3ffc", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "AI / EDIT / REVERT" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 AI 라벨과 설명 트리거, 사용자 수정·되돌리기에 따른 상태 전환을 실제 입력 화면으로 보여줘 구현 가능한 컴포넌트 계약을 제공한다.", "metadata": { "정보렌즈": ["사용자흐름", "브랜드일관성", "접근성", "인터랙션", "AI활용"], "시각렌즈": ["미니멀", "모노톤", "그리드", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/d1665edaa143cbede74495086df633ca/3cbba/text-input-text-area-ai-presence-default.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "component": "Default·Fluid text input AI presence", "states": "AI 생성값→사용자 수정 시 일반 상태→되돌리면 AI 상태 복원", "accessibility": "AI label을 시각 표시와 설명 트리거로 함께 사용" } }, "출처": { "소스": "https://carbondesignsystem.com/components/text-input/usage/#ai-presence", "수집일": "2026-09-06", "수집사유": "최근 30일 갱신 공식 디자인 시스템에서 AI 상태의 실제 화면과 전환 규칙 확인" } }
  },
  {
    title: "Carbon Checkbox Copy — 세 단어와 줄바꿈으로 선택지를 선명하게", category: "콘텐츠 디자인 가이드", date: "2026-09-06", url: "https://carbondesignsystem.com/components/checkbox/usage/#overflow-content",
    summary: "체크박스 그룹은 문장형 제목을 쓰고 개별 라벨은 세 단어 미만으로 유지하며, 넘칠 때 생략하지 않고 상단 정렬된 줄바꿈으로 보존하는 공식 가이드.", note: "카피 길이 원칙을 실제 줄바꿈·정렬 화면과 연결해 설정·필터 폼에서 선택 의미를 잃지 않으면서 밀도를 관리하는 즉시 실행 기준이 됨.", tags: ["#콘텐츠디자인", "#Carbon", "#체크박스", "#마이크로카피", "#줄바꿈", "#접근성"], thumbnail: "https://carbondesignsystem.com/static/9b292d6421efda71c44fa96f4be93833/3cbba/checkbox-usage-10.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "LABEL / WRAP / ALIGN" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 가이드가 그룹 제목·세 단어 미만 라벨·말줄임 금지·상단 정렬 줄바꿈을 실제 화면과 함께 제시해 폼 카피에 바로 적용할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "타이포그래피", "접근성", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://carbondesignsystem.com/static/9b292d6421efda71c44fa96f4be93833/3cbba/checkbox-usage-10.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "그룹 제목은 sentence case→라벨은 명확한 세 단어 미만→생략 금지→넘치면 체크박스 상단에 맞춰 줄바꿈", "visible_examples": "긴 체크박스 라벨의 올바른 다중 행 정렬 화면" } }, "출처": { "소스": "https://carbondesignsystem.com/components/checkbox/usage/#overflow-content", "수집일": "2026-09-06", "수집사유": "최근 30일 갱신 공식 가이드에서 실제 카피와 오버플로 화면 확인" } }
  },
  {
    title: "BARRO — 하나의 타일 모듈이 만드는 반복 그래픽", category: "비주얼 그래픽", date: "2026-09-06", url: "https://www.behance.net/gallery/255232635/BARRO-azulejaria-autoral-um-modulo-que-gera-tudo",
    summary: "단독으로는 미완성인 세라믹 타일 모듈을 반복해 표면 패턴·브랜드 실·워드마크·포스터·웹·모션까지 확장한 비주얼 시스템.", note: "로고와 배경을 따로 만드는 대신 동일 모듈의 반복 규칙으로 밀도와 스케일만 바꿔 다양한 접점의 일관성을 만드는 방식이 강함.", tags: ["#비주얼그래픽", "#모듈", "#패턴", "#타일", "#에디토리얼", "#모션"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/561f8e255232635.6a9a17f7ec61f.png", visual: { background: "#efe6d5", accent: "#e94f37", ink: "#25211e", radiusOne: "0", radiusTwo: "24px", rotate: "-2deg", label: "MODULE / REPEAT / SYSTEM" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "2026-09-04 공개 프로젝트가 하나의 타일 모듈이 반복을 통해 패턴·실·워드마크·포스터·웹·모션으로 변하는 결과를 보여줘 재사용 가능한 모듈 그래픽 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성"], "시각렌즈": ["에디토리얼", "그리드", "매트", "유희적", "모션필"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/561f8e255232635.6a9a17f7ec61f.png", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "system": "단일 세라믹 타일 모듈·반복 규칙·밀도 변화", "applications": "표면 패턴·브랜드 실·워드마크·포스터·웹·모션" } }, "출처": { "소스": "https://www.behance.net/gallery/255232635/BARRO-azulejaria-autoral-um-modulo-que-gera-tudo", "수집일": "2026-09-06", "수집사유": "2026-09-04 공개 Behance 프로젝트에서 모듈 규칙과 다매체 결과 이미지 확인" } }
  },
  {
    title: "III Summit Colombia — 임상 혁신을 인간적인 수렴형 심벌로", category: "브랜드", date: "2026-09-06", url: "https://www.behance.net/gallery/255229839/III-Summit-Colombia-Brand-Verbal-Identity",
    summary: "비대칭 조각이 원으로 수렴하는 심벌, 오렌지·사이언스 블루, 잉크트랩 산세리프로 의료 혁신 행사의 권위와 인간성을 함께 만든 아이덴티티.", note: "과학 행사의 차가움을 단순히 따뜻한 색으로 덮지 않고 집단 수렴이라는 구조를 심벌·언어·타입에 반복해 협업 메시지를 일관되게 전달함.", tags: ["#브랜드", "#의료혁신", "#이벤트", "#심벌", "#타이포그래피", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/299f5c255229839.6a99fa049f87d.jpg", visual: { background: "#f2f0ea", accent: "#f26a32", ink: "#17344b", radiusOne: "50%", radiusTwo: "8px", rotate: "1deg", label: "CONVERGE / HUMAN / SCIENCE" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-09-03 공개 프로젝트가 비대칭 조각의 원형 수렴, 오렌지·블루 팔레트와 잉크트랩 타입을 행사 화면·그래픽에 반복해 의료 혁신 브랜드 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["스위스", "듀오톤", "비대칭", "매트", "따뜻"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/299f5c255229839.6a99fa049f87d.jpg", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "brand_context": "Novartis 임상 혁신 III Summit Colombia", "system": "비대칭 조각의 원형 수렴 심벌·오렌지와 사이언스 블루·잉크트랩 산세리프·집단적 언어" } }, "출처": { "소스": "https://www.behance.net/gallery/255229839/III-Summit-Colombia-Brand-Verbal-Identity", "수집일": "2026-09-06", "수집사유": "2026-09-03 공개 Behance 프로젝트에서 공식 협업 크레딧과 실제 아이덴티티 결과 확인" } }
  },
  {
    title: "Campfire Mug Reshoot — 제품 컷을 야외 온기로 전환", category: "AI 이미지 프롬프트", date: "2026-09-06", url: "https://help.runwayml.com/hc/en-us/articles/50984458662675-Product-Reshoot#campfire-mug",
    summary: "단일 머그 제품 이미지를 Campfire/Outdoor 방향으로 재조명해 따뜻한 야외 광고 장면으로 바꾼 Runway Product Reshoot 공식 결과.", note: "제품 형태를 유지하면서 환경·빛·온도감만 교체하는 짧은 방향어가 실무용 리슈트에 어떻게 작동하는지 입력과 출력으로 비교하기 좋음.", prompt: "Preset: Campfire/Outdoor", tags: ["#AI이미지프롬프트", "#ProductReshoot", "#제품광고", "#야외", "#어스톤", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51009290860819", visual: { background: "#3b2a20", accent: "#e68a42", ink: "#fff3df", radiusOne: "24px", radiusTwo: "50%", rotate: "-1deg", label: "PRODUCT / CAMPFIRE / WARM" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Product Reshoot 문서가 머그 입력, Campfire/Outdoor 방향, Nano Banana 2 기반 설정과 결과 이미지를 함께 제공해 환경 리슈트로 재현할 수 있다.", "metadata": { "정보렌즈": ["AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "어스톤", "중앙집중", "소프트확산광", "글로시", "따뜻"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51009290860819", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Preset: Campfire/Outdoor", "tool_model": "Runway Product Reshoot / Nano Banana 2", "params": "제품 이미지 입력·Campfire/Outdoor preset·16:9 기본·1 output·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51009290860819", "fragment_map": [{ "조각": "coffee mug product input", "효과": "머그의 형태와 제품 식별 정보를 기준으로 유지" }, { "조각": "Campfire", "효과": "따뜻한 불빛과 야간 야외 분위기 추가" }, { "조각": "Outdoor", "효과": "스튜디오 배경을 자연 환경의 제품 장면으로 전환" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/50984458662675-Product-Reshoot", "수집일": "2026-09-06", "수집사유": "최근 공개 공식 도구 문서에서 입력·방향·모델·결과 이미지 확인" } }
  },
  {
    title: "Floating Luggage Ad — 한 문장 콘셉트를 스토리보드로", category: "AI 이미지 프롬프트", date: "2026-09-06", url: "https://help.runwayml.com/hc/en-us/articles/50926961511187-Ad-Concepter#floating-luggage",
    summary: "물에 떨어져 떠오른 여행 가방을 사람들이 발견한다는 짧은 광고 아이디어를 제품·레퍼런스 이미지와 결합해 장면 보드로 확장한 공식 결과.", note: "제품 행동과 관찰자 반응을 두 문장으로 분리해 광고의 사건·제품 기능·인간 반응을 빠르게 시퀀스로 검토할 수 있는 프리비주얼 패턴임.", prompt: "A Luggage falls into the water and floats. People notice the luggage in the water.", tags: ["#AI이미지프롬프트", "#AdConcepter", "#스토리보드", "#여행가방", "#광고기획", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/50995711013139", visual: { background: "#dbe8ee", accent: "#327c9d", ink: "#142a35", radiusOne: "8px", radiusTwo: "24px", rotate: "1deg", label: "FALL / FLOAT / NOTICE" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Runway 공식 Ad Concepter 문서가 전체 콘셉트 문장, 제품·레퍼런스 입력, Claude와 Nano Banana 기반 생성 설정, 결과 보드를 함께 제공해 광고 프리비주얼로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "그리드", "고밀도", "차가움"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/50995711013139", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "A Luggage falls into the water and floats. People notice the luggage in the water.", "tool_model": "Runway Ad Concepter / Claude + Nano Banana", "params": "제품 이미지+레퍼런스 이미지+brief concept·최대 72 credits/generation·aspect ratio/output count/seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/50995711013139", "fragment_map": [{ "조각": "Luggage falls into the water", "효과": "제품이 장면에 진입하는 첫 사건 설정" }, { "조각": "and floats", "효과": "부력이라는 제품 중심 행동을 지속" }, { "조각": "People notice the luggage", "효과": "관찰자의 시선과 반응으로 광고 서사를 확장" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/50926961511187-Ad-Concepter", "수집일": "2026-09-06", "수집사유": "최근 공개 공식 도구 문서에서 전체 콘셉트·입력 구조·모델·결과 이미지 확인" } }
  },
  {
    title: "Creeping Pullback — 전진하는 인물과 후퇴 카메라의 긴장", category: "AI 영상 프롬프트", date: "2026-09-06", url: "https://help.runwayml.com/hc/en-us/articles/50280558448147-Creating-with-Kling-3-0-Motion-Control#camera-pullback",
    summary: "인물이 몸을 낮춰 가까워지는 동안 카메라는 뒤로 빠지게 해 거리 유지와 불안감을 동시에 만드는 Kling 3.0 Motion Control 공식 결과.", note: "참조 퍼포먼스의 신체 동작과 별도의 카메라 후퇴 지시를 결합해 캐릭터 애니메이션에서 주체 크기와 긴장감을 독립 조절하기 좋음.", prompt: "The camera pulls back as he creeps closer", tags: ["#AI영상프롬프트", "#Kling30", "#MotionControl", "#풀백", "#캐릭터", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/50288731078291", visual: { background: "#1d2820", accent: "#8ab04b", ink: "#f0f2e9", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "CREEP / PULL BACK / HOLD" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Kling 3.0 Motion Control 문서가 전체 카메라 프롬프트, 참조 이미지·퍼포먼스 입력, 해상도·길이 설정과 결과 GIF를 함께 제공해 동작과 카메라를 분리 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "인터랙션", "AI활용"], "시각렌즈": ["에디토리얼", "어스톤", "중앙집중", "하드라이트", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/50288731078291", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "The camera pulls back as he creeps closer", "tool_model": "Kling 3.0 Motion Control in Runway", "params": "이미지+참조 퍼포먼스·Image orientation 최대 10초/Video orientation 최대 30초·720p/1080p·16:9/9:16/1:1·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/50288731078291", "fragment_map": [{ "조각": "camera pulls back", "효과": "피사체에서 멀어지는 후퇴 카메라" }, { "조각": "as he creeps closer", "효과": "낮고 조심스러운 전진 동작을 카메라와 반대 방향으로 배치" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/50280558448147-Creating-with-Kling-3-0-Motion-Control", "수집일": "2026-09-06", "수집사유": "최근 30일 공식 문서에서 프롬프트·모델·입력·설정·결과 GIF 확인" } }
  },
  {
    title: "Moonlit Buggy Chase — 프레임 구축과 충격 모션을 분리", category: "AI 영상 프롬프트", date: "2026-09-06", url: "https://help.runwayml.com/hc/en-us/articles/51200261858835-Scene-Builder#buggy-night-scene",
    summary: "대시보드 광각의 달빛 버기 장면을 먼저 만든 뒤 전진 충격, 운전자 흔들림, 후방 모래 분사를 별도 모션 효과로 쌓은 Scene Builder 공식 결과.", note: "정지 키프레임의 스타일·주체·환경·구도와 영상 단계의 카메라·인물·환경 운동을 분리해 복잡한 모빌리티 숏을 디버깅하기 쉬움.", prompt: "the woman drives the buggy. night time. Style: Moonlit realism, desaturated. Subject: Focused, hands firm on wheel. Environment: Empty plains, star-filled sky. Composition: Dashboard perspective, wide-angle. Camera: Dolly bump forward with impact shakes. Character: Head whipping side-to-side with jostling. Environment motion: Sand spray trailing behind vehicle path.", tags: ["#AI영상프롬프트", "#SceneBuilder", "#버기", "#모빌리티", "#달빛", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51252775468563", visual: { background: "#182431", accent: "#6d9fc2", ink: "#eef4f8", radiusOne: "8px", radiusTwo: "24px", rotate: "1deg", label: "FRAME / IMPACT / SPRAY" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Runway 공식 Scene Builder 문서가 프레임 프롬프트, 스타일·주체·환경·구도와 카메라·인물·환경 모션 설정, 결과 GIF를 함께 제공해 단계형 영상 제작 흐름으로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "모노톤", "중앙집중", "하드라이트", "차가움", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51252775468563", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "the woman drives the buggy. night time. Style: Moonlit realism, desaturated. Subject: Focused, hands firm on wheel. Environment: Empty plains, star-filled sky. Composition: Dashboard perspective, wide-angle. Camera: Dolly bump forward with impact shakes. Character: Head whipping side-to-side with jostling. Environment motion: Sand spray trailing behind vehicle path.", "tool_model": "Runway Scene Builder", "params": "Frame 단계: 이미지 참조+구조화 효과·Animate 단계: Camera/Character/Environment motion effects·결과 길이/aspect ratio/seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51252775468563", "fragment_map": [{ "조각": "Moonlit realism, desaturated", "효과": "저채도 달빛 실사 톤 고정" }, { "조각": "Dashboard perspective, wide-angle", "효과": "차량 내부 전경과 평원을 함께 담는 광각 시점" }, { "조각": "Dolly bump forward with impact shakes", "효과": "전진 카메라에 노면 충격 진동 추가" }, { "조각": "Head whipping side-to-side with jostling", "효과": "운전자 신체에 좌우 흔들림 부여" }, { "조각": "Sand spray trailing behind vehicle path", "효과": "차량 후방 궤적에 모래 분사 생성" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/51200261858835-Scene-Builder", "수집일": "2026-09-06", "수집사유": "최근 공개 공식 Scene Builder 문서에서 구조화 프롬프트·도구 설정·결과 GIF 확인" } }
  },
  {
    title: "Coinbase Code Connect Eval — 에이전트 구현 품질을 수치로", category: "AI 디자인", date: "2026-09-05", url: "https://www.figma.com/blog/how-coinbase-used-code-connect-to-shrink-token-costs/",
    summary: "같은 디자인·프롬프트·모델을 반복 실행해 Code Connect 전후의 컴포넌트 선택, 토큰 사용량, 구현 시간과 비용을 비교한 공식 평가 사례.", note: "AI 디자인 워크플로를 감각적으로 평가하지 않고 입력 조건을 고정한 반복 실험과 디자인 시스템 준수율로 검증해 팀 단위 도입 판단에 바로 활용할 수 있음.", tags: ["#AI디자인", "#CodeConnect", "#FigmaMCP", "#디자인시스템", "#에이전트평가", "#테크IT"], thumbnail: "https://cdn.sanity.io/images/599r6htc/regionalized/e186e8339bb81378e7d5bbdc4814ecd95850e73d-1304x1314.png?auto=format&fit=max&h=1088&q=75&w=1080", visual: { background: "#f4f5f7", accent: "#1652f0", ink: "#172b4d", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "DESIGN / MAP / EVALUATE" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Figma 공식 사례가 동일 디자인·프롬프트·Sonnet 4.6 조건의 3회 실행 화면과 Code Connect 적용 전후 토큰·시간·비용 수치를 공개해 디자인 시스템 기반 에이전트 평가 절차로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "브랜드일관성", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://cdn.sanity.io/images/599r6htc/regionalized/e186e8339bb81378e7d5bbdc4814ecd95850e73d-1304x1314.png?auto=format&fit=max&h=1088&q=75&w=1080", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "Code Connect 매핑 갱신→동일 디자인·프롬프트·모델로 3회 구현→컴포넌트·토큰 준수 검토→토큰·시간·비용 비교", "ai_role": "Figma 컴포넌트를 코드 구현 컨텍스트로 제공하고 반복 평가로 품질·효율 변화를 측정" } }, "출처": { "소스": "https://www.figma.com/blog/how-coinbase-used-code-connect-to-shrink-token-costs/", "수집일": "2026-09-05", "수집사유": "2026-09-02 공개 공식 사례에서 실제 평가용 디자인 화면·반복 조건·정량 결과 확인" } }
  },
  {
    title: "Carbon Tooltip Structure — 폭·패딩·캐럿을 토큰으로", category: "웹 스타일가이드", date: "2026-09-05", url: "https://carbondesignsystem.com/components/tooltip/style/",
    summary: "단일·다중 행 툴팁과 정의형 툴팁의 최대 폭, 패딩, 캐럿 크기, 색·타입 토큰과 모바일 배치를 실제 치수 화면으로 정리한 공식 사양.", note: "짧은 라벨과 여러 줄 설명을 같은 팝오버처럼 처리하지 않고 콘텐츠 길이별 구조와 화면 가장자리 규칙을 분리해 구현 편차를 줄이기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#툴팁", "#디자인토큰", "#팝오버", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/34b8126c17ea5fd10a16294b844f0c2c/3cbba/tooltip-style-3.png", visual: { background: "#f4f4f4", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "WIDTH / PADDING / CARET" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 툴팁의 실제 구조 화면과 208·288px 폭, 16px 패딩, 6px 캐럿, 색·타입 토큰을 제공해 구현 가능한 컴포넌트 계약으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "접근성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/34b8126c17ea5fd10a16294b844f0c2c/3cbba/tooltip-style-3.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "tokens": "background-inverse·text-inverse·border-strong·border-interactive·focus·label-01·body-01", "components": "single-line 208px·multi-line 288px·definition 176px·16px padding·6px caret·auto/top/right/bottom/left placement" } }, "출처": { "소스": "https://carbondesignsystem.com/components/tooltip/style/", "수집일": "2026-09-05", "수집사유": "2026-08-27 갱신 공식 디자인 시스템에서 실제 치수 화면·색·타입·간격 토큰 확인" } }
  },
  {
    title: "Figma AI Impact Index — 조사 데이터를 공동 탐색 도구로", category: "AI 디자인", date: "2026-09-04", url: "https://www.figma.com/blog/measuring-the-impact-of-ai/",
    summary: "3년치 설문과 인터뷰 분석을 하나의 HTML 대시보드로 묶고 Figma MCP로 반복 개선해 역할·지역·업무별 AI 영향 변화를 탐색하게 한 공식 사례.", note: "AI를 결과 생성에만 쓰지 않고 대규모 정성·정량 자료를 팀이 함께 검토하는 인터랙티브 시각 도구로 바꾼 점이 리서치 운영 설계에 유용함.", tags: ["#AI디자인", "#리서치", "#대시보드", "#FigmaMCP", "#데이터시각화", "#테크IT"], thumbnail: "https://cdn.sanity.io/images/599r6htc/regionalized/58b463599991d375be5510fe3300760ef109040d-2976x1691.png?auto=format&fit=max&h=614&q=75&rect=1%2C0%2C2974%2C1691&w=1080", visual: { background: "#eceefe", accent: "#5b5bd6", ink: "#1f1d3d", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "SURVEY / INDEX / EXPLORE" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Figma 공식 글이 설문·인터뷰 분석을 HTML 대시보드로 통합하고 MCP로 반복 개선한 과정과 실제 역할·지역별 차트 화면을 공개해 AI 리서치 시각화 흐름으로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "듀오톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://cdn.sanity.io/images/599r6htc/regionalized/58b463599991d375be5510fe3300760ef109040d-2976x1691.png?auto=format&fit=max&h=614&q=75&rect=1%2C0%2C2974%2C1691&w=1080", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "설문·인터뷰 수집→AI 주제 분석→3년 지표 통합→HTML 대시보드 생성→Figma MCP 반복 개선", "ai_role": "대규모 정성·정량 자료를 공통 지표와 탐색 가능한 차트로 구조화" } }, "출처": { "소스": "https://www.figma.com/blog/measuring-the-impact-of-ai/", "수집일": "2026-09-04", "수집사유": "2026-08-28 공개 공식 글에서 AI 분석 절차와 실제 대시보드 화면 확인" } }
  },
  {
    title: "Carbon Toggletip — 클릭형 보조 정보의 상태와 배치 계약", category: "웹 스타일가이드", date: "2026-09-04", url: "https://carbondesignsystem.com/components/toggletip/usage/",
    summary: "클릭·Enter로 열리는 보조 정보 컨테이너의 트리거, 캐럿, 288px 폭, 네 방향 배치, 스크롤과 키보드 종료 동작을 실제 화면으로 정리한 공식 사양.", note: "툴팁과 달리 버튼·링크를 담을 수 있는 경계를 분명히 하고 열림·닫힘·포커스·오버플로를 한 계약으로 묶어 복잡한 인라인 도움말 구현에 옮기기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#토글팁", "#팝오버", "#키보드탐색", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/b2d32185c836b6af7e13ffa20f752fbc/3cbba/toggle-tip-usage-anatomy.png", visual: { background: "#f4f4f4", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "TRIGGER / POPOVER / DISMISS" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Carbon 공식 문서가 토글팁의 실제 anatomy 화면, 288px 폭, 배치·스크롤·열림 상태와 Enter·Space·Escape 동작을 제공해 구현 가능한 컴포넌트 계약으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "접근성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/b2d32185c836b6af7e13ffa20f752fbc/3cbba/toggle-tip-usage-anatomy.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "components": "UI trigger·caret tip·popover container·heading/body/footer", "states": "closed→click/Enter/Space open→focus order 유지→outside click/Escape dismiss" } }, "출처": { "소스": "https://carbondesignsystem.com/components/toggletip/usage/", "수집일": "2026-09-04", "수집사유": "2026-08-27 갱신 공식 디자인 시스템에서 실제 anatomy PNG와 상태·키보드 규칙 확인" } }
  },
  {
    title: "Symmetric Staircase Ascent — 중앙축과 거친 필름 질감의 충돌", category: "AI 영상 프롬프트", date: "2026-09-04", url: "https://help.runwayml.com/hc/en-us/articles/47313504791059-Camera-Terms-Prompts-Examples#symmetrical-staircase",
    summary: "화려한 계단의 완전 대칭 중앙축을 유지하면서 붉은 드레스 인물이 천천히 올라가고 거친 독립영화 질감이 흐르는 공식 Gen-4.5 결과.", note: "기하학적 정돈과 비정제 필름 표면을 한 프롬프트에 분리해 넣어 럭셔리 브랜드 필름이 지나치게 매끈해지는 문제를 조절하기 좋음.", prompt: "Symmetrical scene of a staircase in the center with grand luxurious decor on each side. A woman in a long red dress is walking up the staircase slowly, facing away from the camera. Exact symmetry horizontal symmetry. Raw indie film aesthetic. Heavy grain. Unpolished, authentic, low-budget realism with a surreal, observational feel.", tags: ["#AI영상프롬프트", "#Gen45", "#대칭구도", "#계단", "#필름그레인", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/47313504735251", visual: { background: "#3b2025", accent: "#b63d4c", ink: "#f7eee7", radiusOne: "24px", radiusTwo: "0", rotate: "1deg", label: "AXIS / ASCEND / GRAIN" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 카메라 라이브러리가 전체 프롬프트·Gen-4.5 모델·결과 GIF를 제공해 중앙 대칭, 느린 계단 상승, 붉은 드레스와 거친 필름 질감을 재현할 수 있다.", "metadata": { "정보렌즈": ["AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "중앙집중", "필름그레인", "럭셔리", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/47313504735251", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Symmetrical scene of a staircase in the center with grand luxurious decor on each side. A woman in a long red dress is walking up the staircase slowly, facing away from the camera. Exact symmetry horizontal symmetry. Raw indie film aesthetic. Heavy grain. Unpolished, authentic, low-budget realism with a surreal, observational feel.", "tool_model": "Runway Gen-4.5 Text to Video", "params": "Text to Video·2–10초·16:9/9:16/1:1/4:3/3:4/21:9·720p·24/25fps·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/47313504735251", "fragment_map": [{ "조각": "staircase in the center", "효과": "계단을 화면 중앙의 수직 기준축으로 고정" }, { "조각": "walking up the staircase slowly", "효과": "후면 인물에 느린 상승 동작 부여" }, { "조각": "Exact symmetry horizontal symmetry", "효과": "좌우 장식과 인물 경로를 엄격한 대칭으로 유지" }, { "조각": "Raw indie film aesthetic. Heavy grain", "효과": "럭셔리 공간 위에 거친 저예산 필름 표면 중첩" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/47313504791059-Camera-Terms-Prompts-Examples", "수집일": "2026-09-04", "수집사유": "최근 갱신 공식 라이브러리에서 전체 프롬프트·모델·결과 GIF 확인" } }
  },
  {
    title: "Cliff Arc Reveal — 절벽 인물 주위를 공격적으로 선회", category: "AI 영상 프롬프트", date: "2026-09-04", url: "https://help.runwayml.com/hc/en-us/articles/47313504791059-Camera-Terms-Prompts-Examples#cliff-arc-reveal",
    summary: "구름이 흐르는 협곡 끝 인물을 기준으로 카메라가 빠른 곡선 경로를 그리며 고도감과 낙차를 확장하는 공식 Gen-4.5 결과.", note: "정지 주체와 느린 환경 운동 위에 카메라 아크만 강하게 배치해 모험·아웃도어 캠페인의 스케일 리빌을 짧은 숏으로 설계하기 좋음.", prompt: "A figure stands on a precarious cliff edge, overlooking a chasm filled with slow-moving clouds. The camera executes an aggressive, sweeping arc around the subject. Earthy browns, warm ochres, and muted grays.", tags: ["#AI영상프롬프트", "#Gen45", "#아크숏", "#절벽", "#스케일", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/47313515625875", visual: { background: "#81705b", accent: "#d09a54", ink: "#fff6e9", radiusOne: "24px", radiusTwo: "8px", rotate: "-2deg", label: "EDGE / ARC / REVEAL" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 카메라 라이브러리가 전체 프롬프트·Gen-4.5 모델·결과 GIF를 제공해 절벽 끝 정지 인물, 느린 구름과 공격적 선회 카메라를 분리해 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "어스톤", "비대칭", "하드라이트", "따뜻", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/47313515625875", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "A figure stands on a precarious cliff edge, overlooking a chasm filled with slow-moving clouds. The camera executes an aggressive, sweeping arc around the subject. Earthy browns, warm ochres, and muted grays.", "tool_model": "Runway Gen-4.5 Text to Video", "params": "Text to Video·2–10초·16:9/9:16/1:1/4:3/3:4/21:9·720p·24/25fps·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/47313515625875", "fragment_map": [{ "조각": "figure stands on a precarious cliff edge", "효과": "정지 인물을 낙차가 큰 화면 기준점으로 설정" }, { "조각": "chasm filled with slow-moving clouds", "효과": "협곡 깊이와 느린 환경 운동을 동시에 노출" }, { "조각": "aggressive, sweeping arc around the subject", "효과": "주체 주위에 빠르고 넓은 곡선 카메라 경로 생성" }, { "조각": "Earthy browns, warm ochres, and muted grays", "효과": "지형 중심의 절제된 온난 팔레트 고정" }] } }, "출처": { "소스": "https://help.runwayml.com/hc/en-us/articles/47313504791059-Camera-Terms-Prompts-Examples", "수집일": "2026-09-04", "수집사유": "최근 갱신 공식 라이브러리에서 전체 프롬프트·모델·결과 GIF 확인" } }
  },
  {
    title: "Flyk & smartSIS — 드론 운항 신청과 관제 승인 연결", category: "웹·앱 UI", date: "2026-09-04", url: "https://www.behance.net/gallery/255040987/Flyk-smartSIS",
    summary: "드론 조종사의 비행 금지구역 확인·이륙 신청과 관제 기관의 구역·비행 계획 승인을 두 앱의 실제 지도·폼 화면으로 연결한 UTM 시스템.", note: "서로 다른 권한의 두 제품이 같은 비행 객체와 상태 언어를 공유하면서도 기존 업무 관습을 단계적으로 개선하는 구조가 안전 중심 B2B 리디자인에 참고됨.", tags: ["#웹앱UI", "#드론", "#관제", "#B2B", "#지도UI", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200_webp/cddd8b255040987.6a95648195076.png", visual: { background: "#eef2f5", accent: "#237f9d", ink: "#17252c", radiusOne: "24px", radiusTwo: "8px", rotate: "1deg", label: "ZONE / REQUEST / APPROVE" },
    review: { "유형": "웹·앱 UI", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "최근 공개 프로젝트가 조종사용 Flyk와 관제용 smartSIS의 실제 고해상도 화면과 비행 구역 확인→신청→승인 관계를 보여 줘 다중 역할 안전 업무 흐름으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "브랜드일관성", "접근성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200_webp/cddd8b255040987.6a95648195076.png", "커버리지_카테고리": "웹·앱 UI", "보안_등급": "raw_ok", "type_block": { "screens": "드론 조종사용 Flyk 지도·구역·신청 화면과 관제기관용 smartSIS 구역·비행계획 관리 화면", "flow": "비행 환경·제한 확인→이륙 신청→기관 검토·승인→상태 공유" } }, "출처": { "소스": "https://www.behance.net/gallery/255040987/Flyk-smartSIS", "수집일": "2026-09-04", "수집사유": "2026-08-31 공개 Behance 프로젝트에서 두 역할의 실제 UTM 화면과 1280×2275 공식 이미지 확인" } }
  },
  {
    title: "Tactile Tension — 소프트바디와 고밀도 글리터의 미세 충돌", category: "비주얼 그래픽", date: "2026-09-04", url: "https://www.behance.net/gallery/255157601/Tactile-Tension",
    summary: "말랑한 구체가 고밀도 글리터 입자를 누를 때 미세 충돌과 반짝임이 동시에 반응하도록 X-Particles·Cinema 4D·Redshift로 구축한 매크로 3D 실험.", note: "클레이 단계와 최종 렌더가 함께 공개돼 형태 변형, 입자 밀도, 표면 반짝임을 분리해 뷰티·소재 캠페인의 촉각적 키비주얼로 전이하기 좋음.", tags: ["#비주얼그래픽", "#3D", "#소프트바디", "#글리터", "#매크로", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/c5fd52255157601.6a98356b3f258.jpg", visual: { background: "#d8c4a8", accent: "#9a6fca", ink: "#251f2b", radiusOne: "50%", radiusTwo: "24px", rotate: "-2deg", label: "PRESS / COLLIDE / SHIMMER" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "최근 공개 프로젝트가 소프트바디 압력, 고밀도 입자 미세 충돌과 Redshift 반짝임을 클레이·최종 화면으로 비교해 촉각적 3D 소재 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": [], "시각렌즈": ["3D", "하이채도", "중앙집중", "글로시", "몽환", "모션필"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/c5fd52255157601.6a98356b3f258.jpg", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "system": "소프트바디 변형·고밀도 글리터 입자·미세 충돌·매크로 카메라·Redshift 광택", "applications": "뷰티 소재 컷·테크 제품 표면·모션 아이덴티티" } }, "출처": { "소스": "https://www.behance.net/gallery/255157601/Tactile-Tension", "수집일": "2026-09-04", "수집사유": "2026-09-02 공개 Behance 프로젝트에서 클레이·최종 3D 결과와 1280×684 공식 이미지 확인" } }
  },
  {
    title: "Bostani — 지역 풍경을 잎·선화·맥주 라벨로 연결", category: "브랜드", date: "2026-09-04", url: "https://www.behance.net/gallery/255218047/Bostani",
    summary: "채소밭을 뜻하는 이름의 잎 모티프를 B 로고에 결합하고 지역 교회·나무·집의 선화를 간판과 로컬 맥주 라벨까지 확장한 레스토랑 아이덴티티.", note: "장소의 고유 풍경을 장식 요소로 붙이는 대신 이름의 의미와 식재료 철학, 협업 제품에 같은 선형 문법으로 이어 브랜드 이야기가 자연스럽게 읽힘.", tags: ["#브랜드", "#레스토랑", "#로고", "#패키지", "#선화", "#지역성"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400_webp/a704b7255218047.6a99aa57a138a.jpg", visual: { background: "#ece6d7", accent: "#5c7747", ink: "#273126", radiusOne: "24px", radiusTwo: "8px", rotate: "2deg", label: "LEAF / PLACE / LABEL" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "최근 공개 프로젝트가 잎을 품은 B 로고와 지역 교회·나무·집의 선형 일러스트를 간판·맥주 라벨 결과에 반복 적용해 로컬 브랜드 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["일러스트", "어스톤", "중앙집중", "매트", "따뜻"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400_webp/a704b7255218047.6a99aa57a138a.jpg", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "system": "잎이 결합된 B 로고·지역 풍경 선화·자연색 팔레트", "applications": "레스토랑 간판·로컬 맥주 라벨·패키지" } }, "출처": { "소스": "https://www.behance.net/gallery/255218047/Bostani", "수집일": "2026-09-04", "수집사유": "2026-09-04 공개 Behance 프로젝트에서 로고·간판·라벨의 공식 고해상도 이미지와 지역 서사 확인" } }
  },
  {
    title: "Figma Generative Shaders — 프롬프트에서 인터랙티브 효과와 코드까지", category: "AI 디자인", date: "2026-09-03", url: "https://www.figma.com/blog/how-we-built-generative-plugins-and-shaders/",
    summary: "자연어로 셰이더를 만든 뒤 모션·포인터 반응을 조정하고 코드 확인과 Community 배포까지 잇는 Figma의 생성형 제작 흐름.", note: "AI 결과를 일회성 이미지로 끝내지 않고 편집 가능한 효과·실행 코드·재사용 자산으로 전환하는 단계가 한 화면 흐름 안에 있어 생성형 디자인 도구의 제품 구조를 설계할 때 유용함.", tags: ["#AI디자인", "#Figma", "#생성형셰이더", "#인터랙션", "#모션", "#테크IT"], thumbnail: "https://cdn.sanity.io/images/599r6htc/regionalized/1fa2dc31f016186a80092667f671f74dd11a5104-1200x630.png?w=1200&q=70&fit=max&auto=format", visual: { background: "#0b1020", accent: "#36e1ff", ink: "#ffffff", radiusOne: "18px", radiusTwo: "8px", rotate: "-1deg", label: "PROMPT / MOTION / CODE" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 4 }, "total": 19, "verdict": "accept", "근거": "2026-09-01 Figma 공식 글이 프롬프트 입력, 인터랙티브 셰이더 결과, 코드 접근과 배포 화면을 함께 공개해 생성형 효과 제작 흐름을 제품 패턴으로 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "인터랙션", "AI활용"], "시각렌즈": ["3D", "그라디언트", "중앙집중", "글로시", "유희적", "모션필"], "시각아티팩트_url": "https://cdn.sanity.io/images/599r6htc/regionalized/1fa2dc31f016186a80092667f671f74dd11a5104-1200x630.png?w=1200&q=70&fit=max&auto=format", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "프롬프트로 효과 생성→속성·모션·포인터 반응 조정→코드 확인→Community 배포", "ai_role": "자연어 요구를 편집 가능한 셰이더와 플러그인 코드로 변환" } }, "출처": { "소스": "Figma Blog / Behind the build: Generative plugins and shaders", "수집일": "2026-09-03", "수집사유": "최근 30일 공식 제품 글에서 생성 화면과 결과 효과가 함께 확인됨" } }
  },
  {
    title: "Carbon Notification Style — 상태색과 대비를 토큰 계약으로", category: "웹 스타일가이드", date: "2026-09-03", url: "https://carbondesignsystem.com/components/notification/style/",
    summary: "인라인·토스트·콜아웃 알림의 고대비와 저대비 상태색, 288px 토스트 폭, 간격과 타이포를 실제 컴포넌트로 규정한 Carbon 사양.", note: "성공·정보·경고·오류를 색 하나에 의존하지 않고 아이콘·테두리·배경 토큰의 조합으로 고정해 제품 전반의 상태 피드백과 접근성 검수를 동시에 표준화하기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#알림", "#상태토큰", "#접근성", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/775896245fb41b3eb3920a1020f9abff/3cbba/notification-style-low-contrast.png", visual: { background: "#f4f4f4", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "STATUS / CONTRAST / TOKEN" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 알림 유형별 상태색·대비·크기·간격을 실제 PNG와 토큰으로 연결해 구현 가능한 컴포넌트 계약을 제공한다.", "metadata": { "정보렌즈": ["정보구조", "브랜드일관성", "접근성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/775896245fb41b3eb3920a1020f9abff/3cbba/notification-style-low-contrast.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "component": "notification", "tokens": "status background·border·icon·text, low/high contrast", "dimensions": "toast width 288px; inline·toast·callout variants" } }, "출처": { "소스": "IBM Carbon Design System / Notification style", "수집일": "2026-09-03", "수집사유": "최근 30일 갱신 공식 디자인 시스템에서 상태별 실제 컴포넌트 화면 확인" } }
  },
  {
    title: "Carbon Tree View Copy — 계층 라벨과 생략 위치를 함께 설계", category: "콘텐츠 디자인 가이드", date: "2026-09-03", url: "https://carbondesignsystem.com/components/tree-view/usage/#content",
    summary: "분기와 잎 노드 라벨을 짧고 설명적으로 쓰고, 넘치는 문장은 중간이 아닌 끝에서 생략해 전체 계층의 스캔 규칙을 유지하는 공식 가이드.", note: "카피 길이 규칙을 레이아웃 폭·말줄임·브라우저 툴팁 동작과 함께 정의해 파일 트리나 권한 구조처럼 깊은 계층 UI에서 정보 손실을 줄이는 실행 기준으로 바로 옮길 수 있음.", tags: ["#콘텐츠디자인", "#Carbon", "#트리뷰", "#라벨", "#말줄임", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/0365d4c70b0569cf2a1428f692fdbfa5/3cbba/tree-view-usage-5.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "BRANCH / LEAF / ELLIPSIS" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 분기·잎 라벨 작성법과 끝 말줄임의 실제 전후 화면을 함께 제시해 계층형 제품 카피 규칙으로 즉시 적용할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "타이포그래피", "접근성", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://carbondesignsystem.com/static/0365d4c70b0569cf2a1428f692fdbfa5/3cbba/tree-view-usage-5.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "분기·잎 라벨을 짧고 설명적으로 작성→가용 폭 초과 시 끝에서 생략→브라우저 툴팁으로 전체 값 제공", "visible_examples": "중간 생략과 끝 생략을 나란히 비교한 tree view 화면" } }, "출처": { "소스": "IBM Carbon Design System / Tree view content", "수집일": "2026-09-03", "수집사유": "최근 30일 갱신 공식 가이드에서 실제 라벨과 말줄임 비교 화면 확인" } }
  },
  {
    title: "Motionless Car Arc — 움직임 단서를 지우고 카메라만 이동", category: "AI 영상 프롬프트", date: "2026-09-03", url: "https://help.runwayml.com/hc/en-us/articles/48324313115155-Image-to-Video-Prompting-Guide#motion-cues-car",
    summary: "정지 차량 프레임의 속도감 단서를 최소화한 뒤 피사체는 멈추고 카메라만 강하게 수평 아크 이동하도록 분리한 Gen-4.5 예시.", note: "입력 이미지의 먼지·모션 블러와 프롬프트의 정지 지시가 충돌하는 전후를 실제 출력으로 비교해 제품 영상에서 피사체 고정과 카메라 운동을 분리 제어하는 프롬프트 디버깅 기준으로 유용함.", prompt: "The car is parked and completely motionless. The camera performs an aggressive, sweeping horizontal arc around the parked car.", tags: ["#AI영상프롬프트", "#Runway", "#자동차", "#카메라아크", "#모션제어", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/48367724673683", visual: { background: "#e7d8bb", accent: "#db5d24", ink: "#17130f", radiusOne: "16px", radiusTwo: "6px", rotate: "1deg", label: "STILL CAR / MOVING CAMERA" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Gen-4.5 가이드가 동일 프롬프트에서 입력 프레임의 모션 단서를 줄이기 전후와 실제 GIF 출력을 공개해 정지 피사체·이동 카메라 제어를 검증 가능하게 재현한다.", "metadata": { "정보렌즈": ["AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "어스톤", "중앙집중", "하드라이트", "글로시", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/48367724673683", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "The car is parked and completely motionless. The camera performs an aggressive, sweeping horizontal arc around the parked car.", "tool_model": "Runway Gen-4.5", "params": "Image to Video·first frame input·actual duration/aspect ratio/seed 미공개·모션 단서 최소화 입력과 원본 입력의 비교", "output_url": "https://help.runwayml.com/hc/article_attachments/48367724673683", "fragment_map": [{ "조각": "parked and completely motionless", "효과": "차량 위치와 자체 움직임을 고정" }, { "조각": "aggressive, sweeping horizontal arc", "효과": "피사체 주위를 크게 도는 강한 수평 카메라 이동" }, { "조각": "around the parked car", "효과": "아크 이동의 중심을 차량으로 고정" }] } }, "출처": { "소스": "Runway Help Center / Image to Video Prompting Guide", "수집일": "2026-09-03", "수집사유": "공식 Gen-4.5 가이드에서 프롬프트·모델·입력 비교·실제 GIF 출력 확인" } }
  },
  {
    title: "PopPop — 레트로 만화 문법을 스낵 브랜드 시스템으로", category: "브랜드", date: "2026-09-03", url: "https://dribbble.com/shots/27492411-Japanese-Inspired-Branding-for-a-Snack-Brand",
    summary: "굵은 외곽선, 만화식 방사형 버스트, 이모지형 기호와 마스코트를 밝은 패키지·그래픽 시스템으로 묶은 아시아 시장용 스낵 브랜드 탐색.", note: "문화적 레퍼런스를 단순 장식으로 복사하지 않고 제품의 맛·즐거움·캐릭터라는 브랜드 속성에 연결해 패키지와 캠페인으로 확장한 방식이 소비재 리프레시 실무에 참고할 만함.", tags: ["#브랜드", "#패키지", "#뉴트로", "#마스코트", "#하이채도", "#스낵"], thumbnail: "https://cdn.dribbble.com/userupload/44198798/file/original-930d85329e32cd13ac2fddbc9fa53c1a.png?resize=400x0", visual: { background: "#f8848b", accent: "#ccb450", ink: "#200f0b", radiusOne: "20px", radiusTwo: "10px", rotate: "-2deg", label: "MASCOT / BURST / PACK" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Dribbble New & Noteworthy의 공개 결과 이미지와 제작 설명이 레트로 포스터·만화 버스트·마스코트가 패키지 시스템으로 확장되는 방식을 구체적으로 보여줘 소비재 브랜드에 스타일을 전이할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성"], "시각렌즈": ["뉴트로", "일러스트", "하이채도", "비대칭", "유희적"], "시각아티팩트_url": "https://cdn.dribbble.com/userupload/44198798/file/original-930d85329e32cd13ac2fddbc9fa53c1a.png?resize=400x0", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "brand_context": "아시아 시장 진입을 위한 PopPop 스낵 브랜드 리프레시", "system": "마스코트·굵은 외곽선·버스트·패턴·이모지형 기호를 패키지와 그래픽에 반복" } }, "출처": { "소스": "Dribbble / Zajno — Japanese-Inspired Branding for a Snack Brand", "수집일": "2026-09-03", "수집사유": "최근 New & Noteworthy 목록에서 공개 대표 이미지와 제작 맥락 확인" } }
  },
  {
    title: "Carbon Data Table AI Scope — 테이블·셀·열의 생성 범위를 구분", category: "AI 디자인", date: "2026-09-02", url: "https://carbondesignsystem.com/components/data-table/usage/#ai-presence",
    summary: "AI가 전체 테이블, 개별 셀, 특정 행·열 중 어디에 관여했는지 라벨과 오라의 적용 범위로 구분한 Carbon 공식 패턴.", note: "생성형 데이터 기능에서 AI 라벨을 화면 전체에 과장 적용하지 않고 실제 생성 범위에만 붙여 설명 가능성과 스캔 효율을 함께 지키는 기준으로 활용 가능함.", tags: ["#AI디자인", "#Carbon", "#데이터테이블", "#AI라벨", "#설명가능성", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/e89a6ca012b7ee35e7a397b877e7367e/3cbba/usage-ai-presence-datatable.png", visual: { background: "#f4f4f4", accent: "#8a3ffc", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "TABLE / CELL / SCOPE" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 4 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 전체 테이블·개별 셀·행·열의 AI 범위를 실제 PNG와 적용 규칙으로 함께 보여줘 생성형 데이터 UI의 설명 가능 패턴으로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "접근성", "인터랙션", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/e89a6ca012b7ee35e7a397b877e7367e/3cbba/usage-ai-presence-datatable.png", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "AI 생성 범위 판별→전체 테이블 또는 셀·행·열 단위 스타일 선택→AI 라벨로 설명 팝오버 연결", "ai_role": "실제 생성된 데이터 범위만 시각적으로 표시해 출처와 책임 범위를 명료화" } }, "출처": { "소스": "IBM Carbon Design System / Data table AI presence", "수집일": "2026-09-02", "수집사유": "최근 30일 갱신 공식 문서에서 AI 범위별 실제 데이터 테이블 PNG와 적용 규칙 확인" } }
  },
  {
    title: "Carbon Data Table Anatomy — 밀도 높은 표를 다섯 영역으로", category: "웹 스타일가이드", date: "2026-09-02", url: "https://carbondesignsystem.com/components/data-table/usage/#formatting",
    summary: "제목·도구막대·열 머리글·행·페이지네이션을 분해하고 다섯 행 높이와 그리드 배치를 실제 화면으로 정의한 공식 사양.", note: "데이터 테이블을 셀 집합이 아닌 정보 계층과 전역·행 단위 행동의 계약으로 설계해 복잡한 B2B 제품의 밀도와 탐색 규칙을 통일하기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#데이터테이블", "#컴포넌트해부", "#정보밀도", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/b6071484f2ee4105120300c14cdf48b8/3cbba/datatable-anatomy.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "TITLE / ROW / PAGE" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신 Carbon 공식 문서가 데이터 테이블을 다섯 영역으로 해부하고 행 높이·도구막대·그리드 규칙을 실제 PNG로 제시해 엔터프라이즈 표 컴포넌트 계약으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "접근성", "인터랙션"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/b6071484f2ee4105120300c14cdf48b8/3cbba/datatable-anatomy.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "components": "title·description·toolbar·column header·row·pagination bar와 5개 행 크기", "states": "기본·선택·확장 변형과 wide·narrow·condensed grid 배치" } }, "출처": { "소스": "IBM Carbon Design System / Data table formatting", "수집일": "2026-09-02", "수집사유": "최근 30일 갱신 공식 문서에서 데이터 테이블 해부도와 크기·배치 실제 화면 확인" } }
  },
  {
    title: "Carbon Data Table Copy — 한두 단어 열 제목과 배치 행동 문구", category: "콘텐츠 디자인 가이드", date: "2026-09-02", url: "https://carbondesignsystem.com/components/data-table/usage/#content",
    summary: "표 제목의 목적, 한두 단어 열 제목, 두 줄 이후 말줄임, 문장형 대소문자와 배치 행동의 위치를 실제 테이블에 연결한 콘텐츠 규칙.", note: "열 이름을 짧게 만드는 데 그치지 않고 길이 제한·툴팁·전역 행동 위치를 함께 고정해 데이터가 늘어날 때도 표의 스캔 리듬을 유지할 수 있음.", tags: ["#콘텐츠디자인가이드", "#Carbon", "#데이터테이블", "#열제목", "#배치행동", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/867580b6e4fb44d5069976087f158a43/3cbba/datatable-batch-action.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "TITLE / COLUMN / ACTION" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Carbon 공식 가이드가 표 제목의 목적·한두 단어 열 제목·두 줄 말줄임·문장형 대소문자·배치 행동을 실제 PNG에 연결해 데이터 제품의 카피 검수 절차로 즉시 적용할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "타이포그래피", "접근성", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://carbondesignsystem.com/static/867580b6e4fb44d5069976087f158a43/3cbba/datatable-batch-action.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "표의 공통 목적을 제목으로 작성→열 제목을 1~2단어로 축약→2줄 이후 말줄임·툴팁 적용→문장형 대소문자 검수→전역·배치 행동 위치 확인", "visible_examples": "선택 행 수와 취소·일괄 행동이 도구막대에 나타나는 데이터 테이블" } }, "출처": { "소스": "IBM Carbon Design System / Data table content", "수집일": "2026-09-02", "수집사유": "최근 30일 갱신 공식 문서에서 실제 테이블과 제목·열·행동 카피 규칙 확인" } }
  },
  {
    title: "Warmth in the Shadows — 폐산업 공간을 빛과 환대의 벽화로", category: "비주얼 그래픽", date: "2026-09-02", url: "https://www.behance.net/gallery/254796067/Warmth-in-the-Shadows-ibug-mural-2026",
    summary: "독일 폐공장에 쇼지·밀·바움쿠헨·두루미의 상징을 낮은 조도와 깊은 그림자로 엮어 일상적 환대 장면을 만든 장소 특정적 벽화.", note: "어두운 공간을 단순히 밝히지 않고 남겨 둔 그림자 안에 문화적 단서를 단계적으로 배치해 전시·공간 그래픽에서 서사를 발견하게 하는 방법이 인상적임.", tags: ["#비주얼그래픽", "#벽화", "#공간그래픽", "#스토리텔링", "#그림자", "#문화교류"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/2c405d254796067.6a8dfe8e4fb98.jpg", visual: { background: "#1e1b18", accent: "#d59c62", ink: "#f1e4d1", radiusOne: "24px", radiusTwo: "8px", rotate: "1deg", label: "SHADOW / WHEAT / WELCOME" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "2026-08-25 공개 프로젝트가 폐공장 공간·제작 과정·완성 벽화를 함께 보여주고 쇼지·밀·바움쿠헨·두루미 상징의 역할을 설명해 저조도 공간 서사의 재사용 가능한 시각 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["일러스트", "어스톤", "비대칭", "하드라이트", "매트", "따뜻"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/2c405d254796067.6a8dfe8e4fb98.jpg", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "system": "깊은 그림자·제한된 따뜻한 빛·일본 실내 장면·지역 산업과 문화 교류 상징의 레이어", "applications": "공간 벽화·전시 그래픽·문화 교류 캠페인·장소 기반 스토리텔링" } }, "출처": { "소스": "Behance / YUKIKO IZUMI — Warmth in the Shadows", "수집일": "2026-09-02", "수집사유": "최근 30일 공개 프로젝트에서 제작 과정·완성 벽화·공식 3840px 대표 이미지 확인" } }
  },
  {
    title: "SHIPS — 탄산의 소리와 가시를 패키지 문법으로", category: "브랜드", date: "2026-09-02", url: "https://www.behance.net/gallery/254801533/Ships-shipssssssss",
    summary: "무설탕 탄산의 fizz와 thorn을 큰 세로 워드마크, 고밀도 패턴, 맛별 과일과 가시 화환으로 결합한 레모네이드 아이덴티티.", note: "패턴·과일색·화환이라는 세 층의 고정 구조 안에서 맛별 변주를 만들고 직설적인 보이스까지 같은 태도로 묶어 FMCG 확장 시스템의 근거가 선명함.", tags: ["#브랜드", "#패키지", "#FMCG", "#레모네이드", "#고밀도그래픽", "#보이스톤"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/ba10de254801533.6a9530678231d.png", visual: { background: "#171717", accent: "#f04545", ink: "#f8f1df", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "FIZZ / THORN / FLAVOR" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "2026-08-31 공개 프로젝트가 큰 세로 워드마크·표면 패턴·과일색·맛별 가시 화환과 직설적 보이스를 실제 캔·패키지에 반복해 다품종 FMCG의 확장 가능한 브랜드 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["타이포그래피", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "하이채도", "고밀도", "타이포처리", "매트", "유희적"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/max_3840_webp/ba10de254801533.6a9530678231d.png", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "system": "대형 세로 워드마크·고밀도 패턴·맛별 과일색·동일 윤곽의 가시 화환·직설적 보이스", "applications": "캔·라벨·멀티팩·매장 진열·소셜 커뮤니케이션" } }, "출처": { "소스": "Behance / Daniel Elementorr — SHIPS", "수집일": "2026-09-02", "수집사유": "최근 30일 공개 프로젝트에서 맛별 패키지 시스템·보이스 설명·공식 3840px 대표 PNG 확인" } }
  },
  {
    title: "Novaire AI Assistant — 에이전시 운영 신호를 의사결정으로", category: "AI 디자인", date: "2026-09-01", url: "https://www.behance.net/gallery/255047595/Novaire-Modern-Agency-Management-Dashboard-UI-Design",
    summary: "프로젝트·고객·리드·매출·업무 지표와 AI 어시스턴트를 한 대시보드에 묶어 운영 상태를 빠르게 해석하게 한 에이전시 관리 화면.", note: "AI를 별도 채팅 화면으로 떼지 않고 KPI와 프로젝트 맥락 옆에 두어 데이터 확인→해석→다음 행동의 거리를 줄인 점이 운영형 AI 제품에 유용함.", tags: ["#AI디자인", "#대시보드", "#AI어시스턴트", "#에이전시운영", "#데이터시각화", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/355e4c255047595.6a957d8d3c893.png", visual: { background: "#0f1720", accent: "#66e3c4", ink: "#f4f7f8", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "KPI / INSIGHT / ACTION" },
    review: { "유형": "AI 디자인", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 4 }, "total": 18, "verdict": "accept", "근거": "공개 프로젝트가 프로젝트·고객·리드·매출 KPI와 AI 어시스턴트를 같은 실제 대시보드 화면에 배치해 운영 신호를 해석하고 행동으로 연결하는 AI 제품 구조로 재현할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "타이포그래피", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/355e4c255047595.6a957d8d3c893.png", "커버리지_카테고리": "AI 디자인", "보안_등급": "raw_ok", "type_block": { "workflow": "운영 KPI 확인→프로젝트·고객 상태 탐색→AI 요약 해석→우선 행동 선택", "ai_role": "분산된 운영 지표를 맥락화해 의사결정용 인사이트로 요약" } }, "출처": { "소스": "Behance / Sakib C. — Novaire", "수집일": "2026-09-01", "수집사유": "2026-08-31 공개 프로젝트에서 AI 어시스턴트가 포함된 에이전시 운영 대시보드와 공식 대표 PNG 확인" } }
  },
  {
    title: "Carbon Slider — 단일값·범위·상태를 한 입력 계약으로", category: "웹 스타일가이드", date: "2026-09-01", url: "https://carbondesignsystem.com/components/slider/usage/",
    summary: "단일값과 범위 슬라이더의 해부도, 입력 필드 연동, 키보드 증분, 오류·읽기 전용 상태를 실제 화면과 함께 정의한 공식 사양.", note: "트랙만 그리는 데서 끝나지 않고 숫자 입력·툴팁·키보드·상태를 하나의 계약으로 묶어 데이터 필터와 설정 화면에 그대로 시스템화하기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#슬라이더", "#입력컴포넌트", "#접근성", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/ef012b6b6c1167a676fc44cf9491edab/3cbba/anatomy-default-slider.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "1deg", label: "TRACK / VALUE / STATE" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Carbon 공식 문서가 단일값·범위 해부도와 숫자 입력 연동, 9개 상태, 키보드 증분을 실제 PNG로 제시해 수치 선택 컴포넌트 계약으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "접근성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "여백중심", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/ef012b6b6c1167a676fc44cf9491edab/3cbba/anatomy-default-slider.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "components": "label·min/max value·number input·handle·track과 default·range variant", "states": "enabled·hover·focus·active·error·warning·disabled·read-only·skeleton 및 Arrow·Shift+Arrow·Home·End" } }, "출처": { "소스": "IBM Carbon Design System / Slider usage", "수집일": "2026-09-01", "수집사유": "2026-08-27 갱신 공식 문서에서 실제 슬라이더 해부도 PNG와 상태·키보드 규칙 확인" } }
  },
  {
    title: "Carbon Contained List Copy — 짧은 제목과 평행한 행 구조", category: "콘텐츠 디자인 가이드", date: "2026-09-01", url: "https://carbondesignsystem.com/components/contained-list/usage/",
    summary: "목록 제목을 1~3단어로 제한하고 각 행의 문장 구조와 정보 밀도를 맞추며 온페이지·공개형 목록을 구분하는 Carbon 공식 가이드.", note: "사이드바·카드처럼 좁은 영역에서 행마다 다른 길이의 문장을 넣더라도 제목·문장형·정보 구조를 고정해 스캔 리듬을 지키는 검수 기준으로 바로 쓸 수 있음.", tags: ["#콘텐츠디자인가이드", "#Carbon", "#목록", "#레이블", "#문장구조", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/98f7bc11aaccfbd3ebc009717b8dd150/3cbba/contained-list-usage-1.png", visual: { background: "#ffffff", accent: "#0f62fe", ink: "#161616", radiusOne: "8px", radiusTwo: "0", rotate: "-1deg", label: "TITLE / ROW / ACTION" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 3, "근거성": 5, "가치축": 5 }, "total": 18, "verdict": "accept", "근거": "Carbon 공식 가이드가 1~3단어 제목, 문장형 대소문자, 행별 평행 구조와 길이 제한을 실제 온페이지 목록 PNG에 연결해 좁은 목록 UI의 카피 검수 절차로 즉시 적용할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "타이포그래피", "접근성", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/98f7bc11aaccfbd3ebc009717b8dd150/3cbba/contained-list-usage-1.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "목록 목적 정의→제목을 1~3단어로 작성→행별 정보 구조 평행화→다문단 제거→문장형 대소문자·줄바꿈 검수", "visible_examples": "온페이지 contained list의 헤더·행·인라인 액션과 공개형 목록 비교" } }, "출처": { "소스": "IBM Carbon Design System / Contained list usage", "수집일": "2026-09-01", "수집사유": "2026-08-27 갱신 공식 문서에서 실제 목록 PNG와 제목·행 카피 규칙 확인" } }
  },
  {
    title: "Grapefruit Droplet Layers — 한 장을 투명 편집 레이어로", category: "AI 이미지 프롬프트", date: "2026-09-01", url: "https://help.runwayml.com/hc/en-us/articles/54653749389971-Editing-images-with-Seedream-5-0-Layers#grapefruit-droplet",
    summary: "제품 소셜 이미지에서 자몽 주스 방울을 지정해 독립 투명 레이어로 분리한 Runway 공식 Seedream 5.0 Layers 결과.", note: "짧은 명사구로 분리 대상을 정확히 지목하고 결과를 이동·회전·재배치 가능한 PNG 레이어로 받아 제품 광고의 후반 편집 비용을 줄일 수 있음.", prompt: "Grapefruit juice droplet", tags: ["#AI이미지프롬프트", "#Seedream5", "#레이어분리", "#제품광고", "#투명PNG", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/54656854605715", visual: { background: "#f5c6a5", accent: "#ff6d3a", ink: "#3b2018", radiusOne: "24px", radiusTwo: "8px", rotate: "1deg", label: "PRODUCT / DROPLET / LAYER" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 4, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 가이드가 전체 분리 프롬프트, Seedream 5.0 Layers, 이미지 입력·18크레딧·투명 PNG 설정과 실제 레이어 결과를 공개해 제품 이미지의 선택적 레이어 분리를 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "AI활용"], "시각렌즈": ["미니멀", "파스텔", "중앙집중", "글로시", "따뜻"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/54656854605715", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Grapefruit juice droplet", "tool_model": "Runway / Seedream 5.0 Layers", "params": "image input·18 credits·image-to-transparent-layers·PNG layers·transparent support", "output_url": "https://help.runwayml.com/hc/article_attachments/54656854605715", "fragment_map": [{ "조각": "Grapefruit juice", "효과": "제품 이미지 안에서 자몽 주스 맥락을 유지" }, { "조각": "droplet", "효과": "작은 액체 방울만 별도 투명 레이어로 분리" }] } }, "출처": { "소스": "Runway / Editing images with Seedream 5.0 Layers", "수집일": "2026-09-01", "수집사유": "2026-08-20 공식 예제에서 전체 프롬프트·모델·고정 출력 형식·결과 PNG 확인" } }
  },
  {
    title: "Warehouse Digital Twin Builder — 평면도를 이틀 만에 시뮬레이션으로", category: "웹·앱 UI", date: "2026-09-01", url: "https://www.behance.net/gallery/255059053/NoCode-Warehouse-Digital-Twin-Builder",
    summary: "평면도와 WMS 명명 체계를 가져와 창고 요소를 배치·검증하고 시뮬레이션 가능한 디지털 트윈으로 만드는 노코드 엔터프라이즈 도구.", note: "전문 CAD 없이도 입력→구조화→공간 배치→검증을 단계형 흐름으로 안내해 14일 이상 걸리던 창고 모델링을 약 2일로 줄인 업무 설계가 강함.", tags: ["#웹앱UI", "#디지털트윈", "#노코드", "#창고관리", "#3D인터페이스", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/d0493d255059053.6a95b3c217d21.jpeg", visual: { background: "#eef1f4", accent: "#3569d4", ink: "#18212b", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "PLAN / MODEL / SIMULATE" },
    review: { "유형": "웹·앱 UI", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "공개 사례가 평면도·WMS 구조를 시뮬레이션 가능한 창고 디지털 트윈으로 변환하는 실제 화면과 14일→약 2일 성과를 제시해 복잡한 공간 모델링 흐름으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "타이포그래피", "접근성", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "3D", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/d0493d255059053.6a95b3c217d21.jpeg", "커버리지_카테고리": "웹·앱 UI", "보안_등급": "raw_ok", "type_block": { "screens": "floor-plan import·WMS naming map·3D warehouse builder·validation·simulation-ready export", "flow": "평면도 입력→WMS 구조 매핑→창고 요소 배치→오류 검증→시뮬레이션용 디지털 트윈 생성" } }, "출처": { "소스": "Behance / George Sami — No-Code Warehouse Digital Twin Builder", "수집일": "2026-09-01", "수집사유": "2026-08-31 공개 사례에서 실제 엔터프라이즈 화면·정량 성과와 공식 대표 JPEG 확인" } }
  },
  {
    title: "Symphony of Life — 자동차 기술과 생태를 다층 서사로", category: "비주얼 그래픽", date: "2026-09-01", url: "https://www.behance.net/gallery/255033131/Branding-Design-Symphony-of-Life",
    summary: "자동차 기술을 자연과 대립시키지 않고 우주·생태·기계의 형태가 겹쳐지는 연속 디지털 일러스트로 풀어낸 캠페인 그래픽.", note: "제품을 정면 광고로 보여주기보다 자연의 순환과 기술 디테일을 여러 공간 규모로 교차시켜 지속가능성 메시지를 시각 서사로 확장한 구성이 참고할 만함.", tags: ["#비주얼그래픽", "#자동차", "#디지털일러스트", "#자연기술", "#캠페인", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/a4d4bc255033131.6a9533b34bdf3.jpg", visual: { background: "#112c35", accent: "#ef8b43", ink: "#f0e2c7", radiusOne: "24px", radiusTwo: "8px", rotate: "2deg", label: "NATURE / MACHINE / COSMOS" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "공개 프로젝트가 장성자동차의 기술·자연 공존 개념을 우주·생태·기계 형태가 교차하는 연속 디지털 일러스트로 전개해 지속가능성 캠페인의 재사용 가능한 시각 서사로 추출할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "일러스트", "어스톤", "비대칭", "매트", "몽환"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/a4d4bc255033131.6a9533b34bdf3.jpg", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "system": "자연 생태·기계 부품·우주적 스케일을 겹치는 연속 디지털 일러스트와 절제된 설명 타이포", "applications": "자동차 기술 캠페인·지속가능성 보고 비주얼·전시 그래픽·소셜 연속 이미지" } }, "출처": { "소스": "Behance / Ivan Chung — Symphony of Life", "수집일": "2026-09-01", "수집사유": "2026-08-31 공개 프로젝트에서 자연·기술 공존의 연속 결과물과 1400px 공식 대표 JPEG 확인" } }
  },
  {
    title: "Orba Design — 토성의 궤도를 브라질 큐레이션 언어로", category: "브랜드", date: "2026-09-01", url: "https://www.behance.net/gallery/255023945/Orba-Design-Visual-Identity-Branding",
    summary: "토성과 세계적 궤도 개념을 심벌·편집 타이포·문화 콘텐츠 레이아웃으로 확장한 브라질 디자인·아트 큐레이션 브랜드.", note: "원형 궤도 모티프를 장식으로 반복하지 않고 작품 프레임·페이지 이동·타이포 위계의 공통 규칙으로 바꿔 서로 다른 창작물을 하나의 브랜드 안에 묶은 점이 좋음.", tags: ["#브랜드", "#큐레이션", "#브라질디자인", "#오비트", "#에디토리얼", "#문화플랫폼"], thumbnail: "https://mir-s3-cdn-cf.behance.net/projects/max_808/d39363255023945.Y3JvcCwxMjQ2LDk3NSw3NjgsMzI4NA.png", visual: { background: "#f1eadf", accent: "#c55b45", ink: "#211f1d", radiusOne: "24px", radiusTwo: "8px", rotate: "-2deg", label: "ORBIT / ART / EXCHANGE" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "공개 아이덴티티가 토성·궤도 개념을 심벌, 편집 레이아웃, 큐레이션 터치포인트에 일관되게 적용해 문화 교류 플랫폼의 확장 가능한 브랜드 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "타이포그래피", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "스위스", "어스톤", "비대칭", "매트", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/projects/max_808/d39363255023945.Y3JvcCwxMjQ2LDk3NSw3NjgsMzI4NA.png", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "system": "토성 궤도 심벌·편집 타이포·따뜻한 중성 팔레트·작품 중심 프레임", "applications": "큐레이션 플랫폼·전시 커뮤니케이션·에디토리얼·디지털 콘텐츠" } }, "출처": { "소스": "Behance / Gabre Studio — Orba Design", "수집일": "2026-09-01", "수집사유": "2026-08-31 공개 프로젝트에서 브랜드 시스템·응용 화면과 공식 대표 PNG 확인" } }
  },
  {
    title: "Travel Group Approval — 역할·승인·결제를 한 흐름으로", category: "웹·앱 UI", date: "2026-08-31", url: "https://www.behance.net/gallery/254992595/Travel-App-Smart-Group-Trip-Management-UIUX",
    summary: "그룹 여행의 역할 배정, 참가 승인, 프로필 검토와 결제 상태를 구조화된 멤버 목록과 상태 표시로 연결한 모바일 UI.", note: "누가 참여하고 누가 대기 중이며 어떤 책임을 맡는지 한 흐름에서 비교하게 해 다인 협업 서비스의 승인 병목을 줄이는 정보 구조로 참고하기 좋음.", tags: ["#웹앱UI", "#여행앱", "#그룹관리", "#승인흐름", "#상태표시", "#테크IT"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/9950a8254992595.6a93c63561f76.jpg", visual: { background: "#f3f0eb", accent: "#ef7757", ink: "#202326", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "ROLE / APPROVE / PAY" },
    review: { "유형": "웹·앱 UI", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-30 공개 프로젝트가 역할 배정, 참가 승인, 프로필 검토와 결제 상태를 실제 모바일 화면과 공통 상태 문법으로 연결해 다인 협업 흐름으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "타이포그래피", "인터랙션", "콘텐츠명료성"], "시각렌즈": ["미니멀", "파스텔", "그리드", "여백중심", "절제"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/9950a8254992595.6a93c63561f76.jpg", "커버리지_카테고리": "웹·앱 UI", "보안_등급": "raw_ok", "type_block": { "screens": "역할 배정·참가 대기·승인/거절·멤버 프로필·결제 상태", "flow": "그룹 역할 확인→대기 멤버 검토→프로필 상세→승인 또는 거절→참가·결제 상태 확인" } }, "출처": { "소스": "Behance / Nes-Lab", "수집일": "2026-08-31", "수집사유": "2026-08-30 공개 프로젝트에서 그룹 여행 관리의 실제 모바일 화면과 공식 대표 JPEG 확인" } }
  },
  {
    title: "Oriental Burgundy — 네 단계 적색을 대칭 보태니컬 패턴으로", category: "비주얼 그래픽", date: "2026-08-31", url: "https://www.behance.net/gallery/255006441/Oriental-Burgundy",
    summary: "딥 오베르진·버건디·마젠타·파우더 핑크의 평면 조각을 엄격한 대칭 부케와 반복 패턴으로 전개한 텍스타일 그래픽.", note: "한 색상군의 명도 차와 대칭·대각 그리드만으로 히어로, 반복면, 여백형 보조 패턴의 밀도를 바꿔 패키지·패브릭 시스템에 전이하기 좋음.", tags: ["#비주얼그래픽", "#보태니컬", "#패턴", "#대칭", "#버건디", "#텍스타일"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/99bce5255006441.6a94433f11f60.jpg", visual: { background: "#3d1426", accent: "#ce4a78", ink: "#f5e5df", radiusOne: "50%", radiusTwo: "0", rotate: "0deg", label: "CUT / MIRROR / REPEAT" },
    review: { "유형": "비주얼 그래픽", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-30 공개 프로젝트가 네 단계 적색의 평면 조각, 엄격한 대칭과 대각 그리드를 히어로·반복면·보조 패턴에 일관되게 적용해 재사용 가능한 표면 그래픽 문법으로 추출할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성"], "시각렌즈": ["일러스트", "모노톤", "중앙집중", "매트", "럭셔리"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/99bce5255006441.6a94433f11f60.jpg", "커버리지_카테고리": "비주얼 그래픽", "보안_등급": "raw_ok", "type_block": { "system": "네 단계 적색 팔레트·평면 종이조각형 식물 모티프·엄격한 좌우 대칭", "applications": "다크 히어로 패턴·아이보리 반복면·대각 그리드 보조 패턴" } }, "출처": { "소스": "Behance / Sabrina Nieddu", "수집일": "2026-08-31", "수집사유": "2026-08-30 공개 프로젝트에서 세 가지 실제 패턴 응용과 공식 대표 JPEG 확인" } }
  },
  {
    title: "Pipkins — 여섯 맛을 탐험 캐릭터로 확장한 키즈 요거트", category: "브랜드", date: "2026-08-31", url: "https://www.behance.net/gallery/254641529/Pipkins-Kids-Yogurt-Branding",
    summary: "부모의 안심과 아이의 호기심을 함께 겨냥해 여섯 과일 맛마다 색·성격·탐험 캐릭터를 부여한 요거트 브랜드 시스템.", note: "영양 정보와 캐릭터 놀이를 대립시키지 않고 고정 로고·패키지 구조 위에서 SKU별 모험 서사를 바꿔 제품군 확장과 콘텐츠 운영을 동시에 해결함.", tags: ["#브랜드", "#패키지", "#키즈", "#캐릭터", "#SKU시스템", "#일러스트"], thumbnail: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/3e3e2c254641529.6a93615211534.jpg", visual: { background: "#e8f2d4", accent: "#f08b35", ink: "#173628", radiusOne: "24px", radiusTwo: "50%", rotate: "2deg", label: "FLAVOR / FRIEND / EXPLORE" },
    review: { "유형": "브랜드", "가치축_이름": "스타일추출성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-29 공개 프로젝트가 여섯 맛의 색·캐릭터·성격을 고정 로고와 패키지 구조 안에서 반복해 키즈 식품의 SKU별 스토리텔링 시스템으로 추출할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "브랜드일관성", "콘텐츠명료성"], "시각렌즈": ["일러스트", "하이채도", "그리드", "매트", "유희적"], "시각아티팩트_url": "https://mir-s3-cdn-cf.behance.net/project_modules/1400/3e3e2c254641529.6a93615211534.jpg", "커버리지_카테고리": "브랜드", "보안_등급": "raw_ok", "type_block": { "positioning": "부모에게는 무가당·신뢰, 아이에게는 맛별 탐험 동료", "system": "고정 워드마크·자연색 베이스·6개 SKU 색·맛별 캐릭터와 모험 서사" } }, "출처": { "소스": "Behance / puguh akbar setiawan", "수집일": "2026-08-31", "수집사유": "2026-08-29 공개 프로젝트에서 6종 패키지·캐릭터·브랜드 응용과 공식 대표 JPEG 확인" } }
  },
  {
    title: "Carbon Select AI Presence — 기본·유동형 입력에 AI 상태를 토큰화", category: "웹 스타일가이드", date: "2026-08-31", url: "https://carbondesignsystem.com/components/select/style/#ai-presence",
    summary: "Select의 기본·유동형 구조, 크기·상태·색 토큰과 AI 라벨·오라·경계 토큰을 실제 화면과 수치로 정리한 공식 사양.", note: "일반 입력과 AI 생성 입력이 같은 레이아웃 계약을 유지하면서 필요한 시각 토큰만 전환하게 해 제품군 전체의 AI 상태 표현을 일관되게 구현하기 좋음.", tags: ["#웹스타일가이드", "#Carbon", "#Select", "#디자인토큰", "#AI상태", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/89584947ad858a385012aac8512304dd/3cbba/select-AI-default-style.png", visual: { background: "#f4f4f4", accent: "#8a3ffc", ink: "#161616", radiusOne: "0", radiusTwo: "0", rotate: "0deg", label: "FIELD / LABEL / AURA" },
    review: { "유형": "웹 스타일가이드", "가치축_이름": "시스템화", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신된 Carbon 공식 사양이 Select의 기본·유동형 구조와 상태 토큰, AI 오라·경계·라벨 규칙을 실제 PNG와 수치로 제공해 구현 계약으로 시스템화할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "접근성", "인터랙션", "AI활용"], "시각렌즈": ["미니멀", "모노톤", "그리드", "고밀도", "절제"], "시각아티팩트_url": "https://carbondesignsystem.com/static/89584947ad858a385012aac8512304dd/3cbba/select-AI-default-style.png", "커버리지_카테고리": "웹 스타일가이드", "보안_등급": "raw_ok", "type_block": { "tokens": "$field·$border-strong·$focus·$support-error·$ai-aura-start-sm·$ai-aura-stop·$ai-border-strong", "components": "default·inline·fluid select, hover·focus·invalid·warning·disabled·read-only·AI presence" } }, "출처": { "소스": "Carbon Design System / Select Style", "수집일": "2026-08-31", "수집사유": "2026-08-27 갱신 공식 문서에서 실제 AI Select 화면·토큰·구조·크기 확인" } }
  },
  {
    title: "Carbon Menu Content — 짧은 라벨·업무 순서·12개 상한", category: "콘텐츠 디자인 가이드", date: "2026-08-31", url: "https://carbondesignsystem.com/components/menu/usage/#content",
    summary: "메뉴 라벨을 짧게 쓰고 자주 쓰는 순서로 배치하며 구분선으로 묶고 컨텍스트 메뉴는 12개, 메뉴 버튼은 5개 미만으로 제한하는 공식 가이드.", note: "문구 작성에서 끝나지 않고 빈도·업무 순서·그룹·항목 수와 중첩 깊이를 실제 메뉴 화면에 연결해 고밀도 B2B 액션 목록에 바로 적용 가능함.", tags: ["#콘텐츠디자인", "#Carbon", "#메뉴", "#액션라벨", "#정보순서", "#테크IT"], thumbnail: "https://carbondesignsystem.com/static/4cbc95c12cf030f14ce427f54e96fb6b/3cbba/usage-menu-ordering.png", visual: { background: "#f4f4f4", accent: "#0f62fe", ink: "#161616", radiusOne: "0", radiusTwo: "0", rotate: "0deg", label: "LABEL / ORDER / GROUP" },
    review: { "유형": "콘텐츠 디자인 가이드", "가치축_이름": "실행가능성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "2026-08-27 갱신된 Carbon 공식 가이드가 메뉴 라벨·업무 순서·그룹·항목 상한·서브메뉴 중복 제거를 실제 UI PNG와 함께 제시해 B2B 액션 목록에 즉시 적용할 수 있다.", "metadata": { "정보렌즈": ["정보구조", "사용자흐름", "접근성", "콘텐츠명료성"], "시각렌즈": [], "시각아티팩트_url": "https://carbondesignsystem.com/static/4cbc95c12cf030f14ce427f54e96fb6b/3cbba/usage-menu-ordering.png", "커버리지_카테고리": "콘텐츠 디자인 가이드", "보안_등급": "raw_ok", "type_block": { "procedure": "짧고 정확한 라벨 작성→업무 순서·사용 빈도로 정렬→구분선 그룹화→컨텍스트/오버플로 12개 이하·메뉴 버튼 5개 미만→서브메뉴 1단계 유지", "evidence": "공식 ordering·grouping·item-count·submenu do/don't 실제 화면" } }, "출처": { "소스": "Carbon Design System / Menu Usage", "수집일": "2026-08-31", "수집사유": "2026-08-27 갱신 공식 문서에서 실제 그룹 메뉴 화면과 실행 가능한 콘텐츠 규칙 확인" } }
  },
  {
    title: "Skincare Morning Reshoot — 흰 배경 제품을 욕실 캠페인으로", category: "AI 이미지 프롬프트", date: "2026-08-31", url: "https://help.runwayml.com/hc/en-us/articles/50984458662675-Product-Reshoot#skincare-soft-morning",
    summary: "흰 배경 스킨케어 병을 미니멀한 욕실 카운터와 부드러운 아침빛 속 16:9 제품 광고로 재구성한 공식 결과.", note: "제품 참조는 단순하게 유지하고 배경·광원·시간대만 짧게 지정해 동일 SKU의 채널별 라이프스타일 컷을 빠르게 확장하는 검수 샘플로 쓰기 좋음.", prompt: "minimalist bathroom counter, soft morning light", tags: ["#AI이미지프롬프트", "#NanoBanana2", "#제품리슈트", "#스킨케어", "#소프트광", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51009290863123", visual: { background: "#e8e4de", accent: "#d8bca0", ink: "#2c2926", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "PRODUCT / COUNTER / MORNING" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Product Reshoot 가이드가 흰 배경 스킨케어 입력, 전체 방향 문장, Nano Banana 2·16:9 설정과 결과 PNG를 제공해 소프트 모닝 제품 광고를 재현할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "AI활용", "콘텐츠명료성"], "시각렌즈": ["미니멀", "모노톤", "중앙집중", "소프트확산광", "글로시", "절제"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51009290863123", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "minimalist bathroom counter, soft morning light", "tool_model": "Runway Product Reshoot / Nano Banana 2", "params": "Product input https://help.runwayml.com/hc/article_attachments/51009290861203·16:9 default·text direction·1 output·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51009290863123", "fragment_map": [{ "조각": "skincare bottle on a white background", "효과": "제품 실루엣·라벨·정면 비례를 참조 기준으로 유지" }, { "조각": "minimalist bathroom counter", "효과": "절제된 욕실 상판과 생활 소품 맥락 추가" }, { "조각": "soft morning light", "효과": "낮은 대비의 따뜻한 확산광과 부드러운 그림자 형성" }] } }, "출처": { "소스": "Runway / Product Reshoot", "수집일": "2026-08-31", "수집사유": "최근 공개 공식 앱 가이드에서 제품 입력·전체 방향·모델·설정·결과 PNG 확인" } }
  },
  {
    title: "Headphones Desk Reshoot — 실버 제품을 웜 앰비언트 데스크로", category: "AI 이미지 프롬프트", date: "2026-08-31", url: "https://help.runwayml.com/hc/en-us/articles/50984458662675-Product-Reshoot#headphones-desk-setup",
    summary: "평면 배경의 하이엔드 실버 무선 헤드폰을 데스크 셋업 프리셋과 따뜻한 주변광으로 재촬영한 공식 광고 결과.", note: "환경 프리셋과 광원 지시를 분리해 제품의 금속·패드 재질은 지키면서 사용 장면과 무드를 바꾸는 전자제품 캠페인 변형에 유용함.", prompt: "Preset: Desk Setup + Prompt: warm ambient lighting", tags: ["#AI이미지프롬프트", "#NanoBanana2", "#제품리슈트", "#헤드폰", "#데스크셋업", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51009290864531", visual: { background: "#27231f", accent: "#d89a61", ink: "#f4eee8", radiusOne: "24px", radiusTwo: "50%", rotate: "1deg", label: "METAL / DESK / AMBIENT" },
    review: { "유형": "AI 이미지 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Product Reshoot 가이드가 실버 헤드폰 입력, Desk Setup 프리셋·전체 광원 지시, Nano Banana 2·16:9 설정과 결과 PNG를 제공해 전자제품 데스크 광고를 재현할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "AI활용"], "시각렌즈": ["미니멀", "어스톤", "중앙집중", "소프트확산광", "글로시", "따뜻"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51009290864531", "커버리지_카테고리": "AI 이미지 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Preset: Desk Setup + Prompt: warm ambient lighting", "tool_model": "Runway Product Reshoot / Nano Banana 2", "params": "Product input https://help.runwayml.com/hc/article_attachments/51009290863507·Desk Setup preset·16:9 default·1 output·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51009290864531", "fragment_map": [{ "조각": "high-end silver wireless headphones", "효과": "금속 하우징·이어패드·헤드밴드 비례를 제품 기준으로 유지" }, { "조각": "Desk Setup", "효과": "작업대·주변 기기·사용 맥락을 프리셋으로 구성" }, { "조각": "warm ambient lighting", "효과": "실버 표면에 따뜻한 주변 반사와 부드러운 하이라이트 부여" }] } }, "출처": { "소스": "Runway / Product Reshoot", "수집일": "2026-08-31", "수집사유": "최근 공개 공식 앱 가이드에서 제품 입력·프리셋·전체 방향·모델·설정·결과 PNG 확인" } }
  },
  {
    title: "Goblin Red Eyes Motion Control — 연기는 복사하고 눈빛만 지시", category: "AI 영상 프롬프트", date: "2026-08-31", url: "https://help.runwayml.com/hc/en-us/articles/50280558448147-Creating-with-Kling-3-0-Motion-Control#glowing-red-eyes",
    summary: "한 사람의 연기 영상으로 고블린의 전신·손·표정을 구동하고 텍스트로 붉게 빛나는 눈만 추가한 공식 모션 제어 결과.", note: "퍼포먼스 참조가 담당할 동작과 프롬프트가 담당할 외형 변화를 분리해 캐릭터 정체성을 유지하면서 연출 디테일만 반복 수정하는 방식이 명확함.", prompt: "the goblin has glowing red eyes.", tags: ["#AI영상프롬프트", "#Kling30", "#모션컨트롤", "#캐릭터", "#퍼포먼스참조", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/50292072326803", visual: { background: "#211c19", accent: "#d9362b", ink: "#eee2d6", radiusOne: "24px", radiusTwo: "8px", rotate: "-1deg", label: "PERFORM / PRESERVE / GLOW" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 5, "근거성": 5, "가치축": 5 }, "total": 20, "verdict": "accept", "근거": "Runway 공식 가이드가 퍼포먼스 GIF·캐릭터 PNG·전체 프롬프트, Kling 3.0 Motion Control 설정과 결과 GIF를 제공해 동작 전이와 붉은 눈 외형 지시를 분리해 재현할 수 있다.", "metadata": { "정보렌즈": ["사용자흐름", "인터랙션", "AI활용", "콘텐츠명료성"], "시각렌즈": ["3D", "어스톤", "중앙집중", "하드라이트", "몽환", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/50292072326803", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "the goblin has glowing red eyes.", "tool_model": "Runway / Kling 3.0 Motion Control", "params": "Performance https://help.runwayml.com/hc/article_attachments/50283079538451·Character https://help.runwayml.com/hc/article_attachments/50288731075475·720p/1080p·16:9/9:16/1:1·Image orientation max 10s / Video orientation max 30s·original sound optional", "output_url": "https://help.runwayml.com/hc/article_attachments/50292072326803", "fragment_map": [{ "조각": "performance video", "효과": "전신 움직임·손 제스처·표정을 캐릭터에 전이" }, { "조각": "goblin character image", "효과": "고블린의 얼굴·의상·신체 정체성을 출력 기준으로 유지" }, { "조각": "glowing red eyes", "효과": "퍼포먼스에 없는 붉은 발광 눈 외형만 텍스트로 추가" }] } }, "출처": { "소스": "Runway / Kling 3.0 Motion Control", "수집일": "2026-08-31", "수집사유": "최근 공개 공식 가이드에서 퍼포먼스·캐릭터 입력·전체 프롬프트·모델 설정·결과 GIF 확인" } }
  },
  {
    title: "Luxury Suitcase Reflection — 여행 팔레트와 호텔 반사로 10초 광고", category: "AI 영상 프롬프트", date: "2026-08-31", url: "https://help.runwayml.com/hc/en-us/articles/51200316594707-Product-Shot-Video-Builder#luxury-suitcase-reflection",
    summary: "흰 배경의 레드 여행가방에 웜 트래블 팔레트·젯세터 고객·럭셔리 호텔·반사 콘셉트를 적용해 만든 10초 제품 영상.", note: "팔레트·고객·환경·광고 콘셉트를 독립 입력으로 고정해 제품 광고의 첫 프레임과 움직임을 브랜드 전략에서 직접 이어 가는 방식이 참고됨.", prompt: "Palette: Warm Travel Tones. Audience: Fashion-Forward Jetsetters. Environment: Luxury Hotel Suite. Concept: The Reflection. Motion: none.", tags: ["#AI영상프롬프트", "#Kling30", "#제품광고", "#여행가방", "#럭셔리호텔", "#테크IT"], thumbnail: "https://help.runwayml.com/hc/article_attachments/51290835220115", visual: { background: "#4a241f", accent: "#c64132", ink: "#f6e8dc", radiusOne: "24px", radiusTwo: "0", rotate: "1deg", label: "PALETTE / HOTEL / REFLECT" },
    review: { "유형": "AI 영상 프롬프트", "가치축_이름": "재현성", "scores": { "완성도": 5, "신규성": 4, "근거성": 5, "가치축": 5 }, "total": 19, "verdict": "accept", "근거": "Runway 공식 Product Shot Video Builder 가이드가 레드 여행가방 입력, 팔레트·고객·환경·콘셉트, Kling Standard 3.0의 10초·720p 설정과 결과 GIF를 제공해 럭셔리 제품 숏을 재현할 수 있다.", "metadata": { "정보렌즈": ["브랜드일관성", "AI활용", "콘텐츠명료성"], "시각렌즈": ["에디토리얼", "어스톤", "중앙집중", "글로시", "럭셔리", "모션필"], "시각아티팩트_url": "https://help.runwayml.com/hc/article_attachments/51290835220115", "커버리지_카테고리": "AI 영상 프롬프트", "보안_등급": "raw_ok", "type_block": { "prompt": "Palette: Warm Travel Tones. Audience: Fashion-Forward Jetsetters. Environment: Luxury Hotel Suite. Concept: The Reflection. Motion: none.", "tool_model": "Runway Product Shot Video Builder / Kling Standard 3.0", "params": "Product input https://help.runwayml.com/hc/article_attachments/51289844288531·first frame https://help.runwayml.com/hc/article_attachments/51290835217939·10 seconds·720p default·audio off·16:9 default·seed 미공개", "output_url": "https://help.runwayml.com/hc/article_attachments/51290835220115", "fragment_map": [{ "조각": "Warm Travel Tones", "효과": "레드 제품과 호텔 목재·금속에 맞는 따뜻한 여행 팔레트" }, { "조각": "Fashion-Forward Jetsetters", "효과": "고급 이동과 패션 감도를 소품·공간 선택 기준으로 설정" }, { "조각": "Luxury Hotel Suite", "효과": "제품을 반사면이 있는 프리미엄 숙박 환경에 배치" }, { "조각": "The Reflection", "효과": "가방 실루엣과 표면 반사를 영상의 핵심 광고 동작으로 고정" }, { "조각": "Motion: none", "효과": "앱의 자동 제품 애니메이션에 맡기고 별도 카메라 지시는 생략" }] } }, "출처": { "소스": "Runway / Product Shot Video Builder", "수집일": "2026-08-31", "수집사유": "최근 공개 공식 앱 가이드에서 제품·포지셔닝·첫 프레임·모델·10초 720p 결과 GIF 확인" } }
  },
  {
